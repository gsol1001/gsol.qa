...
/**
 * This test case contain method to test RFI form from Rollover Image (L4 entry point).
 * @author Teng Shyh Wei
 *
 */
public class RFI_Form_0010 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_Form_0010_TestResult;
	...
	@Test(dataProvider="RFI_Form_0010Data")
	public void RFI_Form_0010Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{
			...
			ProductInquiry_Action.ExecuteLoggedIn_GoToL4EntryPoint(dataUsername, dataPassword, dataSearchKeyword);		// L4 entry point			
	 ...
	 */
	@DataProvider
	public Object[][] RFI_Form_0010Data(){
