/**
 * This class contains a method for RFI Inquire All
 * Created: Wed 02 Mar 2016
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2016/03/02
 * 
 * @TestCaseID 35D
 * @TestArea RFI Inquire All
 * @TestScenarioDesc RFI Inquire All for Verified PPs (PA Landing page entry point)
 * @TestStep
 * 
 ...
 * 		2. Click on "Inquire All" button at Inquiry Bar.
 ...
 * 		4. Click on "Contact Supplier Now" button
 * 
...
/**
 * This test case contain method to test RFI Inquire All for Verified PPs (PA Landing page entry point).
 * @author Teng Shyh Wei
 *
 */
public class RFI_PALanding_0004 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_PALanding_0004_TestResult;
	...
	@Test(dataProvider="RFI_PALanding_0004Data")
	public void RFI_PALanding_0004Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{
			...
			// 2. Click on "Inquire All" button at Inquiry Bar
			PA_Landing_Page.btn_clickInqAllForVerPdtAtInqBar().click();
			...
			// b. Uncheck both Verified and Unverified products Inquire All upsell checkbox
			// c. Uncheck the PA upsell checkbox.
			InquiryForm_Action.ExecuteLI1_PdtInq_InqAll_MulVerPdt_SglCat_Info(dataOnlyUnvInqAllUpsell, dataSubject, 
					dataExpOrderQuantity, dataRequestFor, dataMessage, dataPAUpsell);
			
			// To verify both Verified and Unverified prooducts Inquire All upsell checkbox are unchecked
			// To verify the PA upsell checkbox are unchecked
			...
			// To verify RFI upsell section headline 'Find other products similar to {Inquired L4 category}' is displayed.
			// To verify RFI upsell section '8 sibling categories of the inquired L4 category' are displayed.
			// To verify RFI upsell section 'Inquire All button is displayed below each category' are displayed.
		//	RFIConfirmation_Page.check_RFIUpsellSection_PdtSimilar_InqAllExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getL4Category);
			
			// To verify Mini Marketing box 'Go to Global Sources Homepage' link is displayed.
	 ...
	 */
	@DataProvider
	public Object[][] RFI_PALanding_0004Data(){
