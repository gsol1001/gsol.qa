 ...
 * 		password: asdf9876
 *
 * 		1. From any of the following entry point, fill in some text in the RFI static form and click on the"Continue" button:
 * 		   - GSOL PP
 * 		   - Supplier PP
 * 		   - Supplier page /ECI pages
 * 		2. Click on "Contact Supplier Now" button.
 * 
...
/**
 * This test case contain method to test RFI form from Static Form (GSOL PP entry point)
 * @author Teng Shyh Wei
 *
 */
public class RFI_Form_0002 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_Form_0002_TestResult;
	...
	@Test(dataProvider="RFI_Form_0002Data")
	public void RFI_Form_0002Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{	
			...
			// Pre-req: Login to GSOL
			// 1. From any of the following entry point, fill in some text in the RFI static form and click on the"Continue" button:
			//	- GSOL PP,  Supplier PP , or Supplier page /ECI pages	
			ProductInquiry_Action.ExecuteLoggedIn_GSOLPPEntryPoint(dataUsername, dataPassword, dataSearchKeyword);		// GSOL PP entry point
			...
			// To verify the text entered in Step 1 are remain in the Message field				
	 ...
	 */
	@DataProvider
	public Object[][] RFI_Form_0002Data(){
