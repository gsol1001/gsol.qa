/**
 * This class contains a method for Inquire Now for multiple verified product from single category
 ...
 * 		email: autoqa_gsol1004@gmail.com
 * 		password: asdf9876
 * 
 * 		1. As a logged in user, 'inquire now' for multiple verified products from single category and go to RFI form. 
 ...
 * Product Inquiry - Verified, 1 PP/>1PP, 1 Category, Inquire Now.
 * @author Teng Shyh Wei
 *
 */
public class InqFlowLI1_PdtInq_0005 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI1_PdtInq_0005_TestResult;
	...
	@Test(dataProvider="InqFlowLI1_PdtInq_0005Data")
	public void InqFlowLI1_PdtInq_0005Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword,
    	...
    	//	captureInquiryFormPageScreenShot();
    		...
    		String elementL4 = driver.findElement(By.id("noHyperlink")).getText();    		
    		Add_Log.info("Print all text ::" + elementL4);
    		String getL4Category = elementL4.substring(elementL4.lastIndexOf(" ") - 2);		// get last two char in a String
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI1_PdtInq_0005Data(){
