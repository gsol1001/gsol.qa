...
/**
 * This test case contain method to test RFI form from Rollover Image (KWS entry point).
 * @author Teng Shyh Wei
 *
 */
public class RFI_Form_0011 extends SuiteBaseRFI{
	...
	@Test(dataProvider="RFI_Form_0011Data")
	public void RFI_Form_0011Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{
			...
			ProductInquiry_Action.ExecuteLoggedIn_GoToSupplierListTab(dataUsername, dataPassword, dataSearchKeyword);	// KWS entry point
			
			// Store the Supplier Name value
			WebElement selectedElement = driver.findElement(By.xpath("(//*[contains(@class, 'supplierTit')])[position()=1]"));			
			String suppName = selectedElement.getText();
    		Add_Log.info("Inquired Verified Supplier is ::" + suppName);		    		
    		    	
    		// Click on 'Matching products' link.
	 ...
	 */
	@DataProvider
	public Object[][] RFI_Form_0011Data(){
