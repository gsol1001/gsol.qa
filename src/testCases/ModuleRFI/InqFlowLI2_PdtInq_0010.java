 ...
 * @TestStep
 * 
 * 		1. As a non-logged in user, 'inquire now' for single unverified and go to RFI form.
 * 		2. a. Entered some texts in "Subject", "Message" and "Country in which product(s) will be sold:" fields.
 * 		   b. Check the Verified products Inquire All upsell checkbox.
 * 		3. Click on the "Login Now" button.
 * 		4. Fill in E-mail and Password (which used in Pre-req) and click on "Login Now" button.
 ...
 *
 */
public class InqFlowLI2_PdtInq_0010 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI2_PdtInq_0010_TestResult;
	...
	@Test(dataProvider="InqFlowLI2_PdtInq_0010Data")
	public void InqFlowLI2_PdtInq_0010Test(String dataTestCaseName,
		...
		try{
    		...
    		InquiryForm_Action.ExecuteLI2_PdtInq_InqNow_SglUnvPdt_Info(dataSubject, dataExpOrderQuantity, 
    				dataRequestFor, dataMessage, dataOnlyVerInqAllUpsell, dataInqAllRemarks, dataTargetCountry);    		
    		    		     	
    		// To verify Only Verified products Inquire All upsell checkbox is selected.
    		InquiryForm_Page.check_onlyVerInqAllChkbxSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);			
            ...
            InquiryForm_Page.check_onlyVerInqAllChkbxRemainSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);			
    	...
    	//	captureRFIConfirmationPageScreenShot(); 
    		...
    		RFIConfirmation_Page.check_DOIReminderSectionExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI2_PdtInq_0010Data(){
