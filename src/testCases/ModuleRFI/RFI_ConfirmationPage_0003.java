 ...
 * @TestScenarioDesc RFI Confirmation page - RFI upsell section, Inquire All button
 * @TestStep
 * 
 ...
 * 		4. Click on the "Inquire All" button at RFI upsell section
 * 
...
/**
 * This test case contain method to test RFI Flow Logged-in User, Inquire All from RFI upsell section.
 * @author Teng Shyh Wei
 *
 */
public class RFI_ConfirmationPage_0003 extends SuiteBaseRFI{
	...
	@Test(dataProvider="RFI_ConfirmationPage_0003Data")
	public void RFI_ConfirmationPage_0003Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{
			...
			// To verify RFI upsell section 'Inquire All' button is displayed below each category
		//	RFIConfirmation_Action.check_RFIUpsellSection_PdtSimilar_InqAllExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getL4Category);
			...
			// 4. Click on the "Inquire All" button at RFI upsell section.
			RFIConfirmation_Page.btn_clickInquireAll().click();
	 ...
	 */
	@DataProvider
	public Object[][] RFI_ConfirmationPage_0003Data(){
