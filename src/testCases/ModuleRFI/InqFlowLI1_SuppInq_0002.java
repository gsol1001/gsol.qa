 ...
 * 		password: asdf9876
 * 
 * 		1. As a logged in user, 'inquire now' for single verified supplier and go to RFI form.
 * 		2. Fill in all the relevant fields.
 * 		3. Select one of the category under Inquire All dropdown list.
 * 		4. Click on the "Contact Supplier Now" button.
 * 
 ...
 *
 */
public class InqFlowLI1_SuppInq_0002 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI1_SuppInq_0002_TestResult;
	...
	@Test(dataProvider="InqFlowLI1_SuppInq_0002Data")
	public void InqFlowLI1_SuppInq_0002Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword, 
		...
		//	captureHomePageScreenShot();
			...
			// 2. Fill in all the relevant fields.         	
        	// 3. Select one of the category under Inquire All dropdown list.        	
        	InquiryForm_Action.ExecuteLI1_SuppInq_InqNow_SglVerSupp_InqAllDrpdwnSelected(driver, dataSubject, dataMessage, dataInqAllRemarks);
    	...
    	//	captureRFIConfirmationPageScreenShot(); 
    		...
    		// To verify Supplier Alert section is available on the page.
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI1_SuppInq_0002Data(){
