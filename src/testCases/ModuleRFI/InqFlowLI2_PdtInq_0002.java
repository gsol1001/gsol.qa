 ...
 *
 */
public class InqFlowLI2_PdtInq_0002 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI2_PdtInq_0002_TestResult;
	...
	@Test(dataProvider="InqFlowLI2_PdtInq_0002Data")
	public void InqFlowLI2_PdtInq_0002Test(String dataTestCaseName,
		...
		try{
			...
			ProductInquiry_Action.ExecuteInqNow_SglVerPdt_SglCat_SubsCat();
    		...
    		InquiryForm_Action.ExecuteLI2_PdtInq_InqNow_SglVerPdt_SglCat_Info(dataSubject, dataExpOrderQuantity, 
    				dataRequestFor, dataMessage, dataTargetCountry, dataInqAllVerUpsell, dataInqAllUnvUpsell, dataInqAllRemarks);
    	...
    	//	RFIConfirmation_Page.check_SASectionExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);			
    		...
    		RFIConfirmation_Page.check_PASection_UpdateMeOnNewL4Exists(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getSibCategory);
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI2_PdtInq_0002Data(){
