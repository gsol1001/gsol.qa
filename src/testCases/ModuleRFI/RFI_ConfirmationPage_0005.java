 ...
 * @TestScenarioDesc RFI Confirmation page - RFI upsell section, Inquire Now button
 * @TestStep
 * 
 ...
 * 		1. As a logged in user, 'inquire now' for multiple verified product from multiple categories and go to RFI Form.
 * 		   Make sure at least one of the inquired category is one of Pre-req.
 * 		2. a. Fill in all the relevant fields
 * 		   b. Check the PA upsell checkbox
 * 		3. Click on the "Contact Supplier Now" button
 * 		4. Click on the "Contact Now" button at RFI upsell section.
 * 
...
/**
 * This test case contain method to test RFI Flow Logged-in User, Inquire Now from RFI upsell section
 * @author Teng Shyh Wei
 *
 */
public class RFI_ConfirmationPage_0005 extends SuiteBaseRFI{
	...
	@Test(dataProvider="RFI_ConfirmationPage_0005Data")
	public void RFI_ConfirmationPage_0005Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{
			...
			ProductInquiry_Action.ExecuteLoggedIn_InqMulCatPdt(dataUsername, dataPassword, dataSearchKeyword);
			...
			// 2. a. Fill in all the relevant fields.
			// b. Check the PA upsell checkbox
			InquiryForm_Action.ExecuteLI1_PdtInq_InqNow_MulVerPdt_MulCat_Info(
			...
			// To verify RFI upsell section headline 'Find other products you might be interested in' is displayed.
			// To verify RFI upsell section '8 PPs of the inquired L4 category are displayed in each tab' is available on the page
			// To verify RFI upsell section 'Inquire Now' button is displayed below each category			
		//	RFIConfirmation_Action.check_RFIUpsellSection_PdtInterested_InqNowExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// 4. Click on the "Inquire Now" button at RFI upsell section
			RFIConfirmation_Page.btn_clickInquireNow().click();
	 ...
	 */
	@DataProvider
	public Object[][] RFI_ConfirmationPage_0005Data(){
