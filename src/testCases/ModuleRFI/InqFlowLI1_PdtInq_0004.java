 ...
 *
 */
public class InqFlowLI1_PdtInq_0004 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI1_PdtInq_0004_TestResult;
	...
	@Test(dataProvider="InqFlowLI1_PdtInq_0004Data")
	public void InqFlowLI1_PdtInq_0004Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword, 
		...
		//	captureAfterLoginScreenShot();
			...
			// Clear all the PA categories and add PA categories.
    	...
    	//	captureInquiryFormPageScreenShot();
    		...
    		// To store inquired L4 category & sibling category
    		String elementL4 = driver.findElement(By.id("showHyperlink")).getText();    		
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI1_PdtInq_0004Data(){
