 ...
 * 		4. Fill in E-mail and Password (which used i Pre-req) and click on "Login Now" button.
 ...
 *
 */
public class InqFlowLI2_PdtInq_0011 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI2_PdtInq_0011_TestResult;
	...
	@Test(dataProvider="InqFlowLI2_PdtInq_0011Data")
	public void InqFlowLI2_PdtInq_0011Test(String dataTestCaseName, 
		...
		try{
            ...
            InquiryForm_Page.check_onlyVerInqAllChkbxRemainUnchecked(FilePath_TestResult, TestCaseName, DataSet+1, testFail);			
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI2_PdtInq_0011Data(){
