...
/**
 * This test case contain method to test RFI Form from Floating Window (Unverified Supplier PP entry point)
 * @author Teng Shyh Wei
 *
 */
public class RFI_Form_0008 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_Form_0008_TestResult;
	...
	@Test(dataProvider="RFI_Form_0008Data")
	public void RFI_Form_0008Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{
			...
			// As a logged in user, go to GSOL PP entry point, enter search keyword by select Products Page Types.
		...
		//	InquiryForm_Action.ExecuteRFIFloatingWindow_EnterMessage_ClickContinue(dataMessage);
			...
			// 5. To click on "Contact Supplier Now" button.
	 ...
	 */
	@DataProvider
	public Object[][] RFI_Form_0008Data(){
