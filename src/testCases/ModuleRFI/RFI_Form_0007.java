 ...
 * 		6. Select any Verified PP checkboxex
 * 		7. Click on any "Continue" button again
 * 		8. Click on "Contact Supplier Now" button
 */
 ...
 *
 */
public class RFI_Form_0007 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_Form_0007_TestResult;
	...
	@Test(dataProvider="RFI_Form_0007Data")
	public void RFI_Form_0007Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
	...
	//		InquiryForm_Action.ExecuteRFIFloatingWindow_EnterMessage_ClickContinue(dataMessage);
			...
			// 5. Click on the "OK" button.
			PA_Landing_Page.check_alertMsgPlsSelectAtLeastOnePdt(FilePath_TestResult, TestCaseName, DataSet+1, testFail);					
			
			// To verify popup window is closed.
		//	PA_Landing_Page.check_popupWindowIsClosed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			checkPopupWindowIsClosed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 6. Select any Verified PP checkbox
			...
			// 7. Click on the "Continue" button again
			ProductProfile_Page.btn_clickContinueAtRFIFloatingWindow().click();
	 ...
	 */
	@DataProvider
	public Object[][] RFI_Form_0007Data(){
