/**
 * This class contains a method for Inquire All for multiple unverified product
 ...
 * @TestScenarioDesc Product Inquiry - Unverified, >1 PP, Inquire All
 * @TestStep
 * 
 * 		1. As a non-logged in user, 'inquire all' for multiple unverified products and go to RFI form.
 ...
 * Product Inquiry - Unverified extends, >1 PP, Inquire all.
 * @author Teng Shyh Wei
 *
 */
public class InqFlowLI3_PdtInq_0013 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI3_PdtInq_0013_TestResult;
	...
	@Test(dataProvider="InqFlowLI3_PdtInq_0013Data")
	public void InqFlowLI3_PdtInq_0013Test(String dataTestCaseName, 
		...
		try{		
			...
			// 'inquire all' for multiple unverified products
			ProductInquiry_Action.ExecuteInqAll_MulUnvPdt();
    		...
    		InquiryForm_Action.FillIn_Subject_Message_ContactDetails(dataSubject, dataExpOrderQuantity, dataRequestFor, 
    				dataMessage, dataTitle, dataFirstName, dataLastName, dataBusinessEmail, dataCompName, 
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI3_PdtInq_0013Data(){
