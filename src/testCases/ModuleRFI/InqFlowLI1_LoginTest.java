/**
 * This class contains a method to test is user's contact details are pre-populated.
 * Created: Mon 09 March 2015
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2015/03/09
 * 
 ...
 *      2. RFI form is displayed. Verify that: User's contact details are pre-populated. 
 * 
...
/**
 * This test case contain method to test user's contact details are pre-populated for RFI Flow Logged-in user
 * @author Teng Shyh Wei
 *
 */
public class InqFlowLI1_LoginTest extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI1_LoginTest_TestResult;
	...
	@Test(dataProvider="InqFlowLI1_LoginTestData")
	public void InqFlowLI1_LoginTest_Test(String dataTestCaseName, String dataUsername, String dataPassword, 
			String dataPageTypes, String dataSearchKeyword) throws Exception{
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI1_LoginTestData(){
