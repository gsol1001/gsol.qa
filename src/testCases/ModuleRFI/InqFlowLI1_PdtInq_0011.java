 ...
 * Created: Fri 23 January 2015
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2015/01/23
 * 
 * @TestCaseID 1131 /15K
 ...
 * 		password: asdf9876
 * 
 * 		1. As a logged in user, 'inquire now' for single unverified product and go to RFI form.
 * 		2. a. Fill in all the relevant fields. Make sure the email address is the same as in Pre-req.
 ...
 * Product Inquiry - Unverified, 1PP, Inquire Now
 * @author Teng Shyh Wei
 *
 */
public class InqFlowLI1_PdtInq_0011 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI1_PdtInq_0011_TestResult;
	...
	@Test(dataProvider="InqFlowLI1_PdtInq_0011Data")
	public void InqFlowLI1_PdtInq_0011Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword,
		...
		//	captureHomePageScreenShot();
			...
			// 2. a. Fill in all the relevant fields. Make sure the email address is the same as in Pre-req.
        	//    b. Uncheck the Verified products Inquire All upsell checkbox.        	
    		InquiryForm_Action.ExecuteLI1_PdtInq_InqNow_SglUnvPdt_Info(dataSubject, dataExpOrderQuantity, dataRequestFor,
    				dataMessage, dataOnlyVerInqAllUpsell, dataInqAllRemarks);   		
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI1_PdtInq_0011Data(){
