/**
 * This class contains a method for RFI Request Latest Price for Logged-in user.
 ...
 * @TestCaseID 34A
 * @TestArea RFS 
 * @TestScenarioDesc RFI Request Latest Price for logged-in user
 * @TestStep
 * 
 ...
 * 		1. As a logged in user, go to GSOL PP page and click on "Request Latest Price" button.
...
/**
 * This test case contain method to test RFI Request Latest Price for Logged-in user.
 * @author Teng Shyh Wei
 *
 */
public class RFI_RequestLatestPrice_0001 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_RequestLatestPrice_0001_TestResult;
	...
	@Test(dataProvider="RFI_RequestLatestPrice_0001Data")
	public void RFI_RequestLatestPrice_0001Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword, 
		...
		try{
			...
			// 1. As a logged in user, go to GSOL PP page and click on "Request Latest Price" button.
			ProductInquiry_Action.ExecuteLoggedInUser_ClickReqLatestPriceBtn(dataUsername, dataPassword, dataSearchKeyword);
			...
			ProductProfile_Page.check_userNameBusinessEmailPrepopulated(
					FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataFirstName, dataLastName, dataUsername);
			
			// 2. Fill in all the mandatory fields.
			InquiryForm_Action.ExecuteRequestLatestPrice_EnterEOQAndMsgFields(dataExpOrderQuantity, dataMessage);
	 ...
	 */
	@DataProvider
	public Object[][] RFI_RequestLatestPrice_0001Data(){
