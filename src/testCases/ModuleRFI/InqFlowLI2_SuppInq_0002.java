/**
 * This class contains a method for Inquire Now for single verified supplier
 ...
 * 		2. Entered some texts in "Subject" and "Message" fields.
 * 		3. Select one of the category under Inquire All dropdown list.
 * 		4. Click on the "Login Now" button.
 * 		5. Fill in E-mail (autoqa_gsol1001@gmail.com) and Password (asdf9876) and click on "Login Now" button.
 ...
 * Supplier Inquiry - Verified, 1 Supp, Inquire Now.
 * @author Teng Shyh Wei
 *
 */
public class InqFlowLI2_SuppInq_0002 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath = TestCaseListExcel_SuiteRFI_006_TestData;
		FilePath_TestResult = InqFlowLI2_SuppInq_0002_TestResult;
	...
	@Test(dataProvider="InqFlowLI2_SuppInq_0002Data")
	public void InqFlowLI2_SuppInq_0002Test(String dataTestCaseName, 
		...
		try{
            ...
            // Select single verified supplier and click 'Inquire Now' button
            SupplierInquiry_Action.ExecuteInqNow_SglVerSupp();    		
        	...
        	InquiryForm_Action.check_drpdwnInqAllUpsell_CcEmailAddChkbxExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);	

        	
        	// 2. Entered some texts in "Subject" and "Message" fields.
    		// 3. Select one of the category under Inquire All dropdown list.
        	InquiryForm_Action.ExecuteLI2_SuppInq_InqNow_SglVerSupp_InqAllDrpdwnSelected(driver, dataSubject, dataMessage, dataInqAllRemarks);		    	
        	...
        	InquiryForm_Action.check_drpdwnInqAllUpsellSelected_CcEmailAddChkbcRemoved(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
    		
    		
    		// Click on the "Login Now" button and login to GSOL	
			SignIn_Action.ExecuteLoginOnForm(driver, dataUsername, dataPassword);

            // To verify the texts entered in "Subject" and "Message" fields are remain unchanged.
        	...
        	InquiryForm_Page.check_inqAllUpsellDrpdwnRemainSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
    	...
    	//	captureInquiryFormPageScreenShot();
    		...
    		WebElement element = driver.findElement(By.xpath("//*[@id='suppInqAllToggler']/option[2]"));
    		String getL4Category = element.getAttribute("data-catestr");
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI2_SuppInq_0002Data(){
