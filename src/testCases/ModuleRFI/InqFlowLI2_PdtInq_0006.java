/**
 * This class contains a method for Inquire Now for multiple verified products from multiple categories
 ...
 * @TestScenarioDesc Product Inquiry - Verified, >1 PP, >1 Category, Inquire Now
 * @TestStep
 * 
 * 		1. As a non-logged in user, 'inquire now' for multiple verified product from multiple categories and go to RFI form.
 ...
 * 		4. Fill in E-mail Address (autoqa_gsol1005@gmail.com) and Password (asdf9876) and click on "Login Now" button.
 ...
 *
 */
public class InqFlowLI2_PdtInq_0006 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI2_PdtInq_0006_TestResult;
	...
	@Test(dataProvider="InqFlowLI2_PdtInq_0006Data")
	public void InqFlowLI2_PdtInq_0006Test(String dataTestCaseName, 
		...
		try{
			...
			// 1. As a non-logged in user, 'inquire now' for multiple verified products from multiple categories and go to RFI form.   
			// Make sure at least one of the the inquired category is one of the subscribed categories in Pre-req.
        	...
        	// 2. Entered some texts in "Subject", "Message" and "Country in which product(s) will be sold:" fields.        	
    		InquiryForm_Action.FillIn_SubjectUntilTargetCountryFields(dataSubject, dataExpOrderQuantity, dataRequestFor, 
    				dataMessage, dataTargetCountry);		     	
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI2_PdtInq_0006Data(){
