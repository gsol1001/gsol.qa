 ...
 * @TestScenarioDesc Supplier Inquiry - Unverified, 1 Supp, Inquire Now
 * @TestStep
 * 
 * 		1. As a non-logged in user, 'inquire now' for single unverified supplier and go to RFI form.
 * 		2. Fill in all the relevant fields. (use autoqa_gsol1001@gmail.com in Business E-mail field)
 * 		3. Select one of the category under Inquire All dropdown list.
 * 		4. Click on the "Continue to Next Step" button.
 * 		5. Fill in the "Login Password" fields with valid password (asdf9876) and click on "Send Your Inquiry Now" button.
 * 
 ...
 *
 */
public class InqFlowLI3_SuppInq_0003 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath = TestCaseListExcel_SuiteRFI_009_TestData;
		FilePath_TestResult = InqFlowLI3_SuppInq_0003_TestResult;
	...
	@Test(dataProvider="InqFlowLI3_SuppInq_0003Data")
	public void InqFlowLI3_SuppInq_0003Test(String dataTestCaseName, 
		...
		try{
			...
			// 1.  As a non-logged in user, 'inquire now' for single verified supplier and go to RFI form.
    		...
    		// Select multiple verified suppliers and click 'Inquire Now' button
		//	SupplierInquiry_Action.ExecuteInqNow_MulVerSupp();		
    		    		
            // Click on "Compare Supplier" button and click on "Compare" button.
            SupplierInquiry_Action.ExecuteCompareSuppliers();
            
			// Switch to new window opened.
			switchToNewWindowOpened();            
            
            // Check on "Select All" checkbox and click on "Inquire Now" button.
            SupplierInquiry_Action.ExecuteSelectAllChkbx_ClickInqNowBtn();
        	...
        	InquiryForm_Action.check_onlyCcEmailAddrChkbxExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);	
    	...
    	//	captureRFIConfirmationPageScreenShot(); 
    		...
    		// To verify RFI upsell section 'list up to 6 categories based on the categories listed on supp RFI form' is available on the page.
    		// To verify RFI upsell section 'Inquire All' button displayed below each category.
    	//	RFIConfirmation_Action.check_RFIUpsellSection_PdtInterested_InqAllExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI3_SuppInq_0003Data(){
