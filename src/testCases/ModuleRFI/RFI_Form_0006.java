...
/**
 * This test case contain method to test RFI form from Static Form
 * @author Teng Shyh Wei
 *
 */
public class RFI_Form_0006 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_Form_0006_TestResult;
	...
	@Test(dataProvider="RFI_Form_0006Data")
	public void RFI_Form_0006Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{	
			...
			SupplierHome_Action.ExecuteLoggedIn_SupplierECIPagesEntryPoint(dataUsername, dataPassword, dataSearchKeyword);	// Supplier ECI pages entry point
			
			// Fill in some text in the RFI static form and click on the 'Continue' button
			InquiryForm_Action.ExecuteRFIStaticForm_EnterMessage_ClickContinueBtn(dataMessage);
			
			// RFI form is displayed. Verify that user's contact details are pre-populated.
	 ...
	 */
	@DataProvider
	public Object[][] RFI_Form_0006Data(){
