/**
 * This class contains a method for RFI Request Latest Price for non logged-in user.
 ...
 * @TestCaseID 34B
 * @TestArea RFI
 * @TestScenarioDesc RFI Request Latest Price for Non logged-in user 
 * @TestStep
 * 
 ...
 * 		1. As a non-logged in user, go to GSOL PP page and click on "Request Latest Price" button.
 * 		2. Fill in all the mandatory fields.
 * 		3. Click on "Contact Supplier Now" button.
 * 		4. Enter the "Password" field and click on "Send Your Inquiry Now" button.
 * 
...
/**
 * This test case contain method to test RFI Request Latest Price for non logged-in user.
 * @author Teng Shyh Wei
 *
 */
public class RFI_RequestLatestPrice_0002 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_RequestLatestPrice_0002_TestResult;
	...
	@Test(dataProvider="RFI_RequestLatestPrice_0002Data")
	public void RFI_RequestLatestPrice_0002Test(String dataTestCaseName, 
		...
		try{
			...
			// 4. Enter text for Password field and click on 'Send Your Inquiry Now' button
	 ...
	 */
	@DataProvider
	public Object[][] RFI_RequestLatestPrice_0002Data(){
