 ...
 * Product Inquiry - Verified, 1PP/>1PP, 1 Category, Inquire Now.
 * @author Teng Shyh Wei
 *
 */
public class InqFlowLI1_PdtInq_0001 extends SuiteBaseRFI{
	 ...
	 */
	@Test(dataProvider="InqFlowLI1_PdtInq_0001Data")
	public void InqFlowLI1_PdtInq_0001Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword, 
    	...
    	//	captureInquiryFormPageScreenShot();
        	...
        	//	String element = driver.findElement(By.xpath("//*[@id='myInquiryForm']/p[2]/b")).getText();
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI1_PdtInq_0001Data(){
