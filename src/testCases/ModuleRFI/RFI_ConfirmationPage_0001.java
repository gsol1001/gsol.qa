 ...
 * @TestScenarioDesc RFI Confirmation page - Inquire All upsell section, Contact All Suppliers Now button
 * @TestStep
 * 
 ...
 * 		1. As a logged in user, 'inquire now' for single verified product from single category and go to RFI form
 ...
 * 		4. Click on the "Contact All Suppliers Now" button at Inquire All upsell section.
 * 
...
/**
 * This test case contain method to test RFI Flow Logged-in User, Contact All Supplier Now from Inquire All upsell section.
 * @author Teng Shyh Wei
 *
 */
public class RFI_ConfirmationPage_0001 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_Form_0011_TestResult;
	...
	@Test(dataProvider="RFI_ConfirmationPage_0001Data")
	public void RFI_ConfirmationPage_0001Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{
			...
			// 1. As a logged-in user, 'inquire now' for single verified product from single category and go to RFI form.
			ProductInquiry_Action.ExecuteLoggedIn_InqSglVerPdt(dataUsername, dataPassword, dataSearchKeyword);
			...
			// To verify both Verified and Unverified products Inquire All upsell checkbox are unchecked
			// To verify the PA upsell checkbox is unchecked.
			...
			// To verify Inquire All upsell section 'Don't miss out on these x other verified suppliers of {Inquired L4 category}' is displayed.
			// To verify Inquire All upsell section 'Contact All Suppliers Now' button is displayed.			
			RFIConfirmation_Page.check_inqAllUpsellSection_DontMissOutOtherSuppExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			RFIConfirmation_Page.check_inqAllUpsellSection_ContactAllSuppNowBtnExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 4. Click on the "Contact All Suppliers Now" button at Inquire All upsell section.
			RFIConfirmation_Page.btn_clickContactAllSuppNow().click();
	 ...
	 */
	@DataProvider
	public Object[][] RFI_ConfirmationPage_0001Data(){
