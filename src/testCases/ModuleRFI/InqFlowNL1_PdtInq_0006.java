 ...
 * 
 *     	1. As a new user, 'inquire all' for multiple verified products from single category and go to RFI form.
 *     	2. a. Fill in all the relevant fields. (use autoqa_gsolnewxxxx@gmail.com in Business E-mail field)
 *     	   b. Check the Unverified products Inquire All upsell checkbox.
 ...
 *
 */
public class InqFlowNL1_PdtInq_0006 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowNL1_PdtInq_0006_TestResult;
	...
	@Test(dataProvider="InqFlowNL1_PdtInq_0006Data")
	public void InqFlowNL1_PdtInq_0006Test(String dataTestCaseName, 
		...
		try{			
			...
			// 1. As a new user, 'inquire all' for multiple verified products from single category
    	...
    	/*	// To verify Only Unverified products Inquire All upsell checkbox is available on the page.
			...
			//    b. Check the Unverified products Inquire All upsell checkbox.
			//    c. Check the PA upsell checkbox.
    		InquiryForm_Action.ExecuteNL1_PdtInq_InqAll_MulVerPdt_SglCat_Info(dataOnlyUnvInqAllUpsell, dataSubject, 
    		...
    		// To verify PA upsell section 'Hi First Name, please check your e-mail, sent to xyz@xyz.com' is available on the page
    		RFIConfirmation_Page.check_PASection_CheckEmailExists(
    				FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataFirstName, dataBusinessEmail);
    		
    		// To verify PA upsell section '[New PA box] You must click on the link in the e-mail we've sent you to activate your request.' is available on the page
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowNL1_PdtInq_0006Data(){
