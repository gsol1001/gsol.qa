 ...
 * Created: Tue 03 March 2015
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2015/03/03
 * 
 * @TestCaseID 1088 / 13D
 ...
 * @TestStep
 * 
 * 		1. As a non-logged in user, 'inquire now' for multiple verified products from single category and go to RFI form. 
 * 		   Make sure the inquired category is one of the subscribed categories for the user in Pre-req.
 ...
 * 		4. Fill in E-mail Address (autoqa_gsol1003@gmail.com) and Password (asdf9876) and click on "Login Now" button.
 ...
 *
 */
public class InqFlowLI2_PdtInq_0004 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI2_PdtInq_0004_TestResult;
	...
	@Test(dataProvider="InqFlowLI2_PdtInq_0004Data")
	public void InqFlowLI2_PdtInq_0004Test(String dataTestCaseName, 
		...
		try{
			...
			// Login to GSOL, remove all the PA Categories, and add PA Categories
			ProductAlert_Action.ExecuteLoginAction_CleanUpPACategories_AddPACategories(driver, dataUsername, dataPassword);
			...
			ProductInquiry_Action.ExecuteInqNow_MulVerPdt_SglCat_SubsCat();    		
    		...
    		// 3. Click on the "Login Now" button and login to GSOL	
			...
			if(!getL4Category.equals(getSibCategory))
			{
				InquiryForm_Page.check_catPAUpsellChangedToSiblingCategoryIsTrue(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			}else{
				InquiryForm_Page.check_catPAUpsellChangedToSiblingCategoryIsFalse(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			}
			
        	
        	// 5. Make sure the PA upsell checkbox is checked and click on "Continue to Next Step" button.
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI2_PdtInq_0004Data(){
