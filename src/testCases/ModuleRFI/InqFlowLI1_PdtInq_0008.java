 ...
 * Created: Fri 16 January 2015
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2015/01/16
 * 
 * @TestCaseID 1128 / 15H
 ...
 * 		password: asdf9876
 * 
 * 		1. As a logged in user, 'inquire all' for multiple verified products from single category and go to RFI form. 
 ...
 *
 */
public class InqFlowLI1_PdtInq_0008 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowLI1_PdtInq_0008_TestResult;
	...
	@Test(dataProvider="InqFlowLI1_PdtInq_0008Data")
	public void InqFlowLI1_PdtInq_0008Test(String dataTestCaseName,
			String dataUsername, 
			String dataPassword, 
			String dataSearchKeyword,
			String dataProductName, 
			String dataL1Category, 
			String dataL3Category, 
			String dataL4Category, 
			String dataAboutProduct, 
			String dataPdtImgPath,
			String dataEstOrderQuantity, 
			String dataQuantityUnit, 
			String dataCurrency, 
			String dataPrefUnitPrice, 
			String dataValidTo, 
			String dataShipmentTerms, 
			String dataPaymentTerms, 
			String dataCompCert, 
			String dataPdtCert, 
		...
		/*	GetQuotations_Action.ExecuteLI1_FillInAllInfo(dataProductName, dataL1Category, dataL3Category, dataL4Category, 
					dataAboutProduct, dataPdtImgPath, dataEstOrderQuantity, dataQuantityUnit, dataCurrency, dataPrefUnitPrice, 
					dataValidTo, dataShipmentTerms, dataPaymentTerms, dataCompCert, dataPdtCert, dataAggOptIn);
    	...
    	*/	
    	...
    	/*	// To verify Only Unverified products Inquire All upsell checkbox is available on the page.
    		...
    		InquiryForm_Action.check_onlyUnvInqAll_PAUpsellChkbxSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
    		...
    		// 3. Click Contact Supplier Now button
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowLI1_PdtInq_0008Data(){
