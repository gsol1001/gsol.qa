 ...
 * @TestScenarioDesc RFI Inquire Now for Single Verified PP (PA Landing page entry point)
 * @TestStep
 * 
 ...
 * 		3. Click on the "Inquire Now" button at Product Listing details.
 * 		4. a.Fill in all the relevant fields
 * 		   b. Uncheck both Verified and Unverified Inquire All upsell checkboxes.
 ...
 *
 */
public class RFI_PALanding_0001 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_PALanding_0001_TestResult;
	...
	@Test(dataProvider="RFI_PALanding_0001Data")
	public void RFI_PALanding_0001Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,			
			String dataSubject,
		...
		//	PA_Landing_Page.check_ppChkbxIsSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// 3. Click on "Inquire Now" button at Product Listing details.
	 ...
	 */
	@DataProvider
	public Object[][] RFI_PALanding_0001Data(){
