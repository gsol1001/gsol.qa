 ...
 *
 */
public class RFS_Flow_0001 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFS_Flow_0001_TestResult;
	...
	@Test(dataProvider="RFS_Flow_0001Data")
	public void RFS_Flow_0001Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword, 
    	...
    	//	RFIConfirmation_Action.check_RFIUpsellSection_PdtSimilar_InqNowExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getL4Category);
    		...
    		// To verify Mini Marketing Box section 'View all products in {inquired L4 category}' is available on the page.
	 ...
	 */
	@DataProvider
	public Object[][] RFS_Flow_0001Data(){
