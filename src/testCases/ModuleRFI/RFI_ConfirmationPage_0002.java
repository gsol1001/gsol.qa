 ...
 * @TestScenarioDesc RFI Confirmation page - Inquire All upsell section, Contact All Now button
 * @TestStep
 * 
 ...
 * 		4. Click on the "Contact All" button at RFI upsell section.
 * 
...
/**
 * This test case contain method to test RFI Flow Logged-in User, Contact All Now from Inquire All upsell section.
 * @author Teng Shyh Wei
 *
 */
public class RFI_ConfirmationPage_0002 extends SuiteBaseRFI{
	...
	@Test(dataProvider="RFI_ConfirmationPage_0002Data")
	public void RFI_ConfirmationPage_0002Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{
			...
			// To verify both Verified and Unverified products Inquire All upsell checkbox are checked
			...
			// To verify Inquire All upsell section 'You still have x items in your innquiry basket' is displayed.
			// To verify Inquire All upsell section 'Contact All Now' button is displayed.
			RFIConfirmation_Action.check_inqAllUpsellSection_ItemsInInqBasketExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 4. Click on the "Contact All Now" button at Inquire All upsell section.
			RFIConfirmation_Page.btn_clickContactAllNow().click();
	 ...
	 */
	@DataProvider
	public Object[][] RFI_ConfirmationPage_0002Data(){
