 ...
 * 
 *     	1. As a new user, 'inquire now' for multiple verified products from single category and go to RFI form.
 ...
 *
 */
public class InqFlowNL1_PdtInq_0003 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = InqFlowNL1_PdtInq_0003_TestResult;
	...
	@Test(dataProvider="InqFlowNL1_PdtInq_0003Data")
	public void InqFlowNL1_PdtInq_0003Test(String dataTestCaseName, 
		...
		try{			
			...
			//    b. Uncheck Both Verified and Unverified products Inquire All upsell checkbox.
			//    c. Uncheck the PA upsell checkbox.        	
    		InquiryForm_Action.ExecuteNL1_PdtInq_InqNow_MulVerPdt_SglCat_Info(dataInqAllVerUpsell, dataInqAllUnvUpsell, dataSubject, 
    				dataExpOrderQuantity, dataRequestFor, dataMessage, dataTitle, dataFirstName, dataLastName, dataBusinessEmail, 
	 ...
	 */
	@DataProvider
	public Object[][] InqFlowNL1_PdtInq_0003Data(){
