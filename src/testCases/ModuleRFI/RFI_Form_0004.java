 ...
 * 		   - L4
 * 		   - KWS
 * 		2. Click on the Inquire Now link in Rollover Large Image.
 * 		3. Click on the "To:  1 verified supplier (1 product)" link.
 */
...
/**
 * This test case contain method to test RFI form from Rollover Image (PA Landing page entry point).
 * @author Teng Shyh Wei
 *
 */
public class RFI_Form_0004 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_Form_0004_TestResult;
	...
	@Test(dataProvider="RFI_Form_0004Data")
	public void RFI_Form_0004Test(String dataTestCaseName, 
			String dataUsername,
		...
		try{
			...
			WebElement selectedElement = driver.findElement(
					By.xpath("(//*[contains(@class, 'detail_supplierInfo')]//a)[position()=1]"));			
    	...
    	//	PA_Landing_Page.img_rolloverLargerImageDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			    	
    		// Due to Bug#85, move the mouse to temp fixed the issue
    		ProductListing_Page.btn_mouseoverToSearchBtn();
    		
			// 2. Click on the Inquire Now button in Rollover Large Image.
			PA_Landing_Page.btn_clickInqNowOnRolloverImage();
	 ...
	 */
	@DataProvider
	public Object[][] RFI_Form_0004Data(){
