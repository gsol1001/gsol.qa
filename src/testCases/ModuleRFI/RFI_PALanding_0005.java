 ...
 * @TestScenarioDesc RFI Inquire Now for Rollover Large Image, (PA Landing page entry point)
 * @TestStep
 * 
 ...
 * 		2. Mouse over to any PP image.
 * 		2. Click on "Inquire Now" button inside the PP image.
...
/**
 * This test case contain method to test RFI Inquire Now from Rollover Large Image (PA Landing page entry point).
 * @author Teng Shyh Wei
 *
 */
public class RFI_PALanding_0005 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_PALanding_0005_TestResult;
	...
	@Test(dataProvider="RFI_PALanding_0005Data")
	public void RFI_PALanding_0005Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,			
			String dataSubject,
		...
		//	PA_Landing_Page.chkbx_selectMultipleVerPdt();
		...
		//	PA_Landing_Page.btn_clickInqNowForVerPdtAtBtmInqBar().click();
			...
			// To verify both Verified and Unverified products Inquire All upsell checkbox is not selected.
		...
		//	RFIConfirmation_Action.check_inqAllUpsellSection_DontMissOutOtherSuppExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
    		...
    		RFIConfirmation_Action.check_RFIUpsellSection_PdtSimilar_InqNowExists(
	 ...
	 */
	@DataProvider
	public Object[][] RFI_PALanding_0005Data(){
