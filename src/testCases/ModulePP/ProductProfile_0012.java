/**
 * This class contains a method for RFS flow (Login on form) (GSOL PP page entry point)
 ...
 * @TestScenarioDesc RFS flow (Login on form) (GSOL PP page entry point)
 * @TestStep
 * 
 * 		1. As a non logged-in user, go to GSOL PP page.
 * 		2. Click on "Request Sample" link.
 * 		3. Enter some texts in "Subject", "Message" and "Number of Samples" fields.
 * 		4. Click on the "Login Now" button.
 * 		5. Fill in E-mail and Password and click on "Login Now" button.
 * 		6. Fill in all the relevant fields and click on the "Continue to Next Step" button.
 * 		
 * 
...
/**
 * This test case contain method to test RFS flow (Login on form) (GSOL PP page entry point).
 * @author Teng Shyh Wei
 *
 */
public class ProductProfile_0012 extends SuiteBasePP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductProfile_0012_TestResult;
	...
	@Test(dataProvider= "ProductProfile_0012Data")
	public void ProductProfile_0012Test(String dataTestCaseName, 
		...
		try{
			...
			// 3. Enter some texts in "Subject", "Message" and "Number of Samples" fields.
			InquiryForm_Action.ExecuteRFS_FillIn_SubjectMessageAndNumOfSamples(dataSubject, dataMessage, dataNumOfSamples);
			
			// To verify "Subject", "Message" and "Number of Samples" fields are entered with text.
			...
			// To verify RFS form is displayed. Verify that the text entered in "Subject", "Message" and "Number of Samples" are remain unchanged.
			InquiryForm_Page.check_subjectMessageAndNumOfSamplesRemainUnchanged(
					FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataSubject, dataMessage, dataNumOfSamples);
	 ...
	 */
	@DataProvider
	public Object[][] ProductProfile_0012Data(){
