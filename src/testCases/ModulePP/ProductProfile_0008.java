/**
 * This class contains a method for PA Lite signup for logged-in user (GSOL PP page entry point)
 * Created: Tue 03 Oct 2017
 * @author Teng Shyh Wei
 * @version 0.1 Date: 2017/10/03
 * 
 * @TestCaseID 39H
 * @TestArea Product Profile
 * @TestScenarioDesc PA Lite signup for logged-in user (GSOL PP page entry point)
 * @TestStep
 * 
 * 		Pre-req: 
 * 		1. Clear Cache & Cookie on the browser before starting the test:
 * 		2. The current category has been subscribed by current logged in user.
 * 		email: autoqa_gsol1007@gmail.com
 * 		password: asdf9876
 * 		
 * 		1. Go to GSOL PP page.
 * 		2. Click on "Login" button.
 * 		3. Fill in Username and Password and click on "Login Now" button.
 * 		4. Click on the "View latest products" link.
 * 
...
/**
 * This test case contain method to test PA Lite signup for logged-in user (GSOL PP page entry point).
 * @author Teng Shyh Wei
 *
 */
public class ProductProfile_0008 extends SuiteBasePP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductProfile_0008_TestResult;
	...
	@Test(dataProvider= "ProductProfile_0008Data")
	public void ProductProfile_0008Test(String dataTestCaseName, 
		...
		try{
			...
			// Pre-req: The current category has been subscribed by current logged in user.
	
			// 1. Go to the GSOL PP page.
		//	ProductInquiry_Action.ExecuteLoggedIn_GSOLPPEntryPoint(dataUsername, dataPassword, dataProductKeyword);
		//	ProductInquiry_Action.ExecuteNonLoggedIn_GSOLPPEntryPoint(dataProductKeyword);
			...
			ProductInquiry_Action.ExecuteSearchByProducts_GoToSupplierListTab(dataProductKeyword);
			...
			// To verify the original entry point page is displayed. Verify that PA Enhanced Entrance "View latest products" link is displayed.
			...
			// 4. Click on "View latest products" link.
	 ...
	 */
	@DataProvider
	public Object[][] ProductProfile_0008Data(){
