/**
 * This class contains a method for SA for registered user (GSOL PP page entry point)
 ...
 * @TestScenarioDesc SA for registered user (GSOL PP page entry point)
 * @TestStep
 * 
 ...
 * 		3. Enter a registered email and click on "Send me updates" button.
 * 		4. Enter the password field and click on "Login Now" button.
 * 		5. The "Follow" icon in the GSOL PP page become "(green tick) Following".
 * 		6. Click on "Following" icon.
 * 		
 * 
...
/**
 * This test case contain method to test SA for registered user (GSOL PP page entry point).
 * @author Teng Shyh Wei
 *
 */
public class ProductProfile_0010 extends SuiteBasePP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductProfile_0010_TestResult;
	...
	@Test(dataProvider= "ProductProfile_0010Data")
	public void ProductProfile_0010Test(String dataTestCaseName, 
		...
		try{
			...
			// Get Supplier Name in the GSOL PP page
			...
			// 5. The "Follow" icon in the GSOL PP page became "(green tick) Following".			
			...
			// 6. Click on "Following" icon.
			ProductProfile_Page.icon_clickFollowing().click();
			
			// To verify SA Edit Suppliers page is displayed. Following's Supplier name is added into "Verified suppliers" section.
			SupplierAlert_Action.ExecuteSAEditSuppPage_FollowingSuppAddedToSupplierAlert(FilePath_TestResult, TestCaseName, DataSet+1, testFail, suppName);			
	 ...
	 */
	@DataProvider
	public Object[][] ProductProfile_0010Data(){
