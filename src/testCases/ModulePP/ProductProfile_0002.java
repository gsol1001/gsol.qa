 ...
 * @version 0.1 Date: 2016/07/07
 * 
 * @TestCaseID 36B
 * @TestArea Product Profile
 * @TestScenarioDesc RFI Inquire Now from Product Profile page.
 * @TestStep
 *
 * 		1. As a non-logged in user, go to Product Profile page.
 * 		2. Click on the "Inquire Now" button.
 * 		3. Enter some texts in "Subject", "Message" and "Country in which product(s) will be sold:" fields, click on "Login Now" button.
 * 		4. Fill in E-mail and Password and click on "Login Now" button.
...
/**
 * This test case contain method to test RFI Login on Form, Inquire Now from Product Profile page.
 * @author Teng Shyh Wei
 *
 */
public class ProductProfile_0002 extends SuiteBasePP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductProfile_0002_TestResult;
	...
	@Test(dataProvider="ProductProfile_0002Data")
	public void ProductProfile_0002Test(String dataTestCaseName, 
		...
		try{
			...
			// 2. Click on the "Inquire Now" button.
			ProductProfile_Page.btn_clickInquireNow().click();
			...
			// 3. Enter some texts in "Subject", "Message" and "Country in which product(s) will be sold:" fields.
			// Click on "Login Now" button.
			InquiryForm_Action.ExecuteLI2_PdtInq_InqNow_SglVerPdt_SglCat_Info(dataSubject, dataExpOrderQuantity, dataRequestFor, 
					dataMessage, dataTargetCountry, dataInqAllVerUpsell, dataInqAllUnvUpsell, dataInqAllRemarks);
			...
			// To verify the RFI form is displayed.
			// Verify that the text entered in "Subject", "Message" and "Country in which product(s) will be sold:" are remain unchanged.
			InquiryForm_Page.check_textSubjectMessageTargetCountryRemainUnchanged(FilePath_TestResult, 
					TestCaseName, DataSet+1, testFail, dataSubject, dataMessage, dataTargetCountry);
	 ...
	 */
	@DataProvider
	public Object[][] ProductProfile_0002Data(){
