/**
 * This class contains a method for Inquire now from RFI static form in GSOL PP page (Post Login)
 ...
 * @TestScenarioDesc Inquire now from RFI static form in GSOL PP page (Post Login)
 * @TestStep
 * 
...
import appModules.ProductProfile_Action;
...
/**
 * This test case contain method to test Inquire now from RFI static form in GSOL PP page (Post Login)
 * @author Teng Shyh Wei
 *
 */
public class ProductProfile_0016 extends SuiteBasePP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductProfile_0016_TestResult;
	...
	@Test(dataProvider= "ProductProfile_0016Data")
	public void ProductProfile_0016Test(String dataTestCaseName, 
		...
		try{
			...
			// 2. Fill in some text in the RFI static form and click on the "Continue" button.
			ProductProfile_Action.ExecuteRFIStaticForm_EnterMessage_ClickContinueBtn(dataMessage);
			
			// To verify RFI form is displayed. The text entered in Step 2 are remain in the Message field.
			...
			// 3. Fill in all the relevant fields and click on "Continue To Next Step" button.
			InquiryForm_Action.ExecuteRFIStaticForm_FillInAllTheRelevantFields(dataSubject, dataExpOrderQuantity, dataUOM, dataInqAllVerUpsell, 
					dataInqAllUnvUpsell, dataInqAllRemarks, dataTitle, dataFirstName, dataLastName, dataBusinessEmail, dataCompName, 
			...
			// 4. Fill in the "Password" field with valid password and click on "Send Your Inquiry Now" button.
	 ...
	 */
	@DataProvider
	public Object[][] ProductProfile_0016Data(){
