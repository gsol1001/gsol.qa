/**
 * This class contains a method for Inquire now from RFI static form in GSOL PP page (Login on form)
 ...
 * @TestScenarioDesc Inquire now from RFI static form in GSOL PP page (Login on form)
 * @TestStep
 * 
...
/**
 * This test case contain method to test Inquire now from RFI static form in GSOL PP page (Login on form)
 * @author Teng Shyh Wei
 *
 */
public class ProductProfile_0015 extends SuiteBasePP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductProfile_0015_TestResult;
	...
	@Test(dataProvider= "ProductProfile_0015Data")
	public void ProductProfile_0015Test(String dataTestCaseName, 
		...
		try{
			...
			// To verify that the text entered in Step 2 are remain unchanged in the Message field.
			InquiryForm_Action.check_RFIFormDisplayed_TextEnteredInRFIStaticFormRemainUnchanged(
					FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataUsername, dataMessage);
			
			// 5. Fill in all the relevant fields and click on the "Continue to Next Step" button.
	 ...
	 */
	@DataProvider
	public Object[][] ProductProfile_0015Data(){
