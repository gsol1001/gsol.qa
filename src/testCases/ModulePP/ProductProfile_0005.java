/**
 * This class contains a method for PA Lite signup for lite user (GSOL PP page entry point)
 ...
 * @TestScenarioDesc PA Lite signup for lite user (GSOL PP page entry point)
 * @TestStep
 * 
 * 		Pre-req: 1. Clear Cache & Cookie on the browser before starting the test:
 * 				 2. User has already subscribed for Product Alert.
 * 				 Email: autoqa_gsol1013@gmail.com
 * 
 * 		1. As a logged in PA Lite user, go to GSOL PP page.
...
/**
 * This test case contain method to test PA Lite signup for lite user (GSOL PP page entry point).
 * @author Teng Shyh Wei
 *
 */
public class ProductProfile_0005 extends SuiteBasePP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductProfile_0005_TestResult;
	...
	@Test(dataProvider= "ProductProfile_0005Data")
	public void ProductProfile_0005Test(String dataTestCaseName, 
		...
		//	PALite_Signup_Action.ExecutePPEnhancedEntrance_EnterEmailAddr_ClickSubscribeBtn(dataBusinessEmail);
			...
			// To verify Warning page is displayed. Verify that warning message is displayed with 
			...
			// 5. Fill up all the mandatory fields and click on the "Register Now" button.
	 ...
	 */
	@DataProvider
	public Object[][] ProductProfile_0005Data(){
