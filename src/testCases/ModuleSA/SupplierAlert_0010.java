 ...
 * Created: Wed 03 Feb 2016
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2016/02/03
 * 
 * @TestCaseID 27J
 * @TestArea SA
 ...
 *     	password: asdf9876
 *     	
 *     	1. As a Logged-in user, go to KWS page entry point.
...
/**
 * This test case contain method to test SA for Logged-in user (KWS page entry point).
 * @author Teng Shyh Wei
 *
 */
public class SupplierAlert_0010 extends SuiteBaseSA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAlert_0010_TestResult;
	...
	@Test(dataProvider="SupplierAlert_0010Data")
	public void SupplierAlert_0010Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			// To verify KWS page entry point is displayed.
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAlert_0010Data(){
