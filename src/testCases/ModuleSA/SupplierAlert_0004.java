 ...
 *     	7. Click on "Skip this step" link.
 *     	8. Click on "click here" link in SA copy.
 *     	9. Verify that the "Follow Me" button in the original page became "(green tick) Following".
 *     
...
/**
 * This test case contain method to test SA for upgrade user (Supplier Product Showroom page entry point).
 * @author Teng Shyh Wei
 *
 */
public class SupplierAlert_0004 extends SuiteBaseSA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAlert_0004_TestResult;
	...
	@Test(dataProvider="SupplierAlert_0004Data")
	public void SupplierAlert_0004Test(String dataTestCaseName, 
		...
		try{		
			...
			// Pre-req: Subscribe to PA Lite or eMag Lite using autoqa_gsolnewxxxx@gmail.com
			...
			// 1. From Supplier Product Showroom page entry points, click on the "Follow Me" button next to supplier's name:
			SupplierAlert_Action.ExecuteSA_GoToSupplierPdtShowroomPage_ClickFollowMeBtn(dataSearchKeyword);
			...
			// 9. The "Follow Me" link in the original page became "(green tick) Following."
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAlert_0004Data(){
