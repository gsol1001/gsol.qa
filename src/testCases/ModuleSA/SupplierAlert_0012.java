 ...
 *     	password: asdf9876
 *     	
 *     	1. As a Logged-in user, go to Supplier KWS page entry point.
...
/**
 * This test case contain method to test SA for Logged-in user (Supplier KWS page entry point).
 * @author Teng Shyh Wei
 *
 */
public class SupplierAlert_0012 extends SuiteBaseSA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAlert_0012_TestResult;
	...
	@Test(dataProvider="SupplierAlert_0012Data")
	public void SupplierAlert_0012Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			SupplierListing_Page.check_supplierKWSPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataSearchKeyword);
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAlert_0012Data(){
