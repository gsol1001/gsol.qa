 ...
 * Created: Mon 04 Jan 2016
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2016/01/04
 * 
 * @TestCaseID 27G
 * @TestArea SA
 * @TestScenarioDesc SA from RFI Confirmation page
 * 
 * @TestStep
 * 
 ...
 *     	4. Click on the "Follow Now" button.
 *     	5. Click on the "click here." hyperlink.
 *     
...
/**
 * This test case contain method to test SA from RFI Confirmation page.
 * @author Teng Shyh Wei
 *
 */
public class SupplierAlert_0007 extends SuiteBaseSA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAlert_0007_TestResult;
	...
	@Test(dataProvider="SupplierAlert_0007Data")
	public void SupplierAlert_0007Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		*/	
			...
			// 'inquire now' for single verified products from single category.
    		...
    		// To verify SA section is available if the user has not yet follow this supplier.
    		...
    		RFIConfirmation_Page.check_SAChkbxIsPrechecked(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
    		
			// 4. Click on the "Follow Now" button.
			RFIConfirmation_Page.btn_clickFollowNow().click();
						
			// To verify SA section with the following is displayed:
			...
			RFIConfirmation_Page.check_copySuccFollowingExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail, suppName);
			RFIConfirmation_Page.check_copyViewEditSuppExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			RFIConfirmation_Page.check_clickHereIsHyperlink(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
						
			// 5. Click on "click here" link in SA copy.
			RFIConfirmation_Page.lnk_clickOnClickHere().click();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAlert_0007Data(){
