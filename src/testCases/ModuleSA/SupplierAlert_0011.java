 ...
 *     	password: asdf9876
 *     	
 *     	1. As a Logged-in user, go to L4 entry point.
...
/**
 * This test case contain method to test SA for Logged-in user (L4 entry point).
 * @author Teng Shyh Wei
 *
 */
public class SupplierAlert_0011 extends SuiteBaseSA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAlert_0011_TestResult;
	...
	@Test(dataProvider="SupplierAlert_0011Data")
	public void SupplierAlert_0011Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			// To verify the L4 entry point is displayed.
		//	ProductListing_Page.check_L4CategoryPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataL4Category);
			...
			// 2. Click on the "Follow Me" button next to supplier's name
			ProductListing_Page.btn_clickFollowMe();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAlert_0011Data(){
