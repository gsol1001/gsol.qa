 ...
 *     	password: asdf9876
 *      Note down the following supplier for this user.
 *
 *     	
 ...
 *
 */
public class SupplierAlert_0008 extends SuiteBaseSA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAlert_0008_TestResult;
	...
	@Test(dataProvider="SupplierAlert_0008Data")
	public void SupplierAlert_0008Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{		
    		...
    		// To verify SA section is not available.
    		RFIConfirmation_Page.check_SASectionNotExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAlert_0008Data(){
