 ...
 *     	6. Click on "Skip this step" link.
 *     	7. Click on "click here" link in SA copy.
 *     	8. Verify that the "Follow Me" link in the original page became "(green tick) Following".
 *     
...
/**
 * This test case contain method to test SA for new user (Supplier Homepage entry point).
 * @author Teng Shyh Wei
 *
 */
public class SupplierAlert_0002 extends SuiteBaseSA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAlert_0002_TestResult;
	...
	@Test(dataProvider="SupplierAlert_0002Data")
	public void SupplierAlert_0002Test(String dataTestCaseName, 
		...
		try{		
			...
			// 1. From Supplier Homepage entry points, click on the "Follow Me" button next to supplier's name:
			SupplierAlert_Action.ExecuteSA_GoToSuppHomepage_ClickFollowMeBtn(dataSearchKeyword);
						
			WebElement suppElement = driver.findElement(By.xpath("//h1[contains(@class, 'spName')]"));
			...
			// 6. Click on "Skip this step" link.
			PA_AddCategories_Page.lnk_clickSkipThisStep().click();
			...
			// 8. The "Follow Me" link in the original page became "(green tick) Following."
			
			// To verify that the "Follow Me" link in the original page became "(green tick) Following".
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAlert_0002Data(){
