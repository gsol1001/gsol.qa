 ...
 * 		
 * 		9. Click on "Product Alert" tab in the Top Nav.
 * 		10. Click on the "Login" button in PA Marketing page.
 * 		11. Fill in "E-mail (or Username)" and "Password" field with valid email and password.
 * 		12. Click on "Login Now" button.
 * 		13. Click on "Logout" button in Global Nav.
 ...
 *
 */
public class Login_0005 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Login_0005_TestResult;
	...
	@Test(dataProvider="Login_0005Data")
	public void Login_0005Test(String dataTestCaseName, 
		...
		try{		
			...
			// 2. Click on the "Login" button in PA Marketing page.
			...
			// To verify user login successfully. PA Homepage page is displayed. 
