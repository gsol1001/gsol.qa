 ...
 * 		13. Repeat Step 1 - 9 for RFS form.
 * 
 ...
 *
 */
public class RFI_BuyerProfile_0001 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_BuyerProfile_0001_TestResult;
	...
	@Test(dataProvider="RFI_BuyerProfile_0001Data")
	public void RFI_BuyerProfile_0001Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			// 5. Fill in the 'Message' field and unchecked the "Remember my preference" checkbox.
			InquiryForm_Action.FillInMessage_RememberMyPrefChkbx(dataMessage, dataRememberMyPref);
		...
		//	ProductInquiry_Action.ExecuteInqSglVerPdt(dataSearchKeyword);
			...
			// To verify RFI form is displayed.
			// To verify all radio button and checkbox options are available in the Buyer Profile section.
		...
		//	ProductInquiry_Action.ExecuteInqSglVerPdt(dataSearchKeyword);
			...
			// 13. Repeat Step 1 - 9 for RFS form.
			// Please refer to RFS_BuyerProfile_0001.java
	 ...
	 */
	@DataProvider
	public Object[][] RFI_BuyerProfile_0001Data(){
