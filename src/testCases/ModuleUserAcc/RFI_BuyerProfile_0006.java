 ...
 * @version 1.01 Date: 2017/03/21
 * 
 * @TestCaseID 26K
 * @TestArea Buyer Profile
 * @TestScenarioDesc Buyer Profile link in User Profile page
 * @TestStep
 * 
 * 		Pre-req: Login to GSOL using the following information before starting the test:
 * 		
 * 		1. As a logged in user, go to User Profile page.
 * 		2. Click on "Buyer Profile" link below the "Submit" button.
 * 		3. Verify that the following options are available in the My Buyer Profile Setting section:
 * 		   a) Always ask me before sending future inquiries
 * 		   b) Do not ask me again. Always disclose my Buyer Profile to suppliers.
 * 		   c) Do not ask me again. I do not wish to disclose my Buyer Profile to suppliers in relation to future inquiries
 * 		4. Inquire on any product(s) and go to RFI form.
 * 		5. Verify that the following options are available in the Buyer Profile section:
 * 		   a) Yes, include my Buyer Profile for this inquiry
 * 		   b) No, do not send this time
 * 		   c) 'Remember my preference' checkbox
 * 		6. Verify that option "Yes, include my Buyer Profile for this inquiry" is checked as default.
 * 		7. Verify that checkbox "Remember my preference" is checked as default
 * 		8. Fill in all the relevant fields and click on "Contact Supplier Now" button
 * 
...
/**
 * This test case contain method to test Buyer Profile link in User Profile page.
 * @author Teng Shyh Wei
 *
 */
public class RFI_BuyerProfile_0006 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_BuyerProfile_0006_TestResult;
	...
	@Test(dataProvider="RFI_BuyerProfile_0006Data")
	public void RFI_BuyerProfile_0006Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			// 2. Click on "Buyer Profile" link below the "Submit" button.
			UserProfile_Page.lnk_clickBuyerProfile().click();
			
			// To verify Buyer Profile page is displayed.
			BuyerProfile_Page.check_buyerProfilePageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 3. To verify that the following options are available in the My Buyer Profile Setting section.
			// a) Always ask me before sending future inquiries
			// b) Do not ask me again. Always disclose my Buyer Profile to suppliers.
			// c) Do not ask me again. I do not wish to disclose my Buyer Profile to suppliers in relation to future inquiries.
			BuyerProfile_Page.check_buyerProfileSettingSectionExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
		    // 3. Select 'Always ask before sending future inquiries' radio button
			...
			BuyerProfile_Page.check_radioBtnAlwaysAskIsSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// 5. To verify that the following options are available in the Buyer Profile section:
			// a) Yes, include my Buyer Profile for this inquiry
			// b) No, do not send this time
			// c) 'Remember my preference' checkbox
	 ...
	 */
	@DataProvider
	public Object[][] RFI_BuyerProfile_0006Data(){
