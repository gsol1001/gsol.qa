 ...
 * @TestCaseID 1013 / 2B
 * @TestArea Login
 * @TestScenarioDesc User is unable to login when username is valid and password is invalid
 * @TestStep
 * 
 ...
 * 		   - Global Navigation
 * 		   - CPP
 * 		2. Fill in "E-mail Address (or Username)" and "Password" field with valid email (autoqa_gsol1007@gmail.com) and invalid password (asdf8765).
...
/**
 * This test case contain method to test user is unable to login when username is valid and password is invalid.
 * @author Teng Shyh Wei
 *
 */
public class Login_0002 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Login_0002_TestResult;
	...
	@Test(dataProvider="Login_0002Data")
	public void Login_0002Test(String dataTestCaseName, String dataUsername, String dataPassword) throws Exception{
		...
		try{		
			...
			// 2. Fill in "E-mail Address (or Username)" and "Password" field with valid email and invalid password.      
			SignIn_Action.ExecuteFillIn_UsernamePassword(dataUsername, dataPassword);       
            
			// To verify "E-mail Address (or Username)" and "Password" fields are filled up.
            LogIn_Page.check_txtbxUsernamePasswordIsEntered(FilePath_TestResult, TestCaseName, 
            		DataSet+1, testFail, dataUsername, dataPassword);
            
			// 3. Click on "Login Now" button.
			LogIn_Page.btn_clickLoginNow();
			
			// To verify user is unable to login. 
			...
			SignIn_Action.ExecuteInvLoginErrorMsgIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
