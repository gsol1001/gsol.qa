 ...
 * @TestScenarioDesc Buyer Profile section - Always disclose
 * @TestStep
 * 
 * 		Pre-req: Login to GSOL using the following information before starting the test:
 * 		Email: autoqa_gsol1009@gmail.com
 * 		password: asdf9876
 * 		Make sure this user has Buyer Profile setting set to "Do not ask me again. 
 * 		Always disclose my Buyer Profile to suppliers." in User Profile.
 * 
 * 		1. As a logged in user, 'request for sample' for single verified products and go to RFS form.
 * 		2. Verify that the following copy is displayed in the Buyer Profile section:
 ...
 * 		3. Fill in the 'Message', 'Number of Samples' fields and click on 'Contact Supplier Now' button.
 * 
...
/**
 * This test case contain method to test RFS Buyer Profile section - always disclose
 * @author Teng Shyh Wei
 *
 */
public class RFS_BuyerProfile_0002 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFS_BuyerProfile_0002_TestResult;
	...
	@Test(dataProvider="RFS_BuyerProfile_0002Data")
	public void RFS_BuyerProfile_0002Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			// 1. As a logged in user, 'request for sample' for single verified products and go to RFS form.
			ProductInquiry_Action.ExecuteLoggedIn_ReqForSample_SglVerPdt(dataUsername, dataPassword, dataSearchKeyword);
			...
			// 'You have chosen to always include your Buyer Profile to suppliers.
			// Note: Supplier(s) will also be able to view your future profile updates.'
			InquiryForm_Page.check_buyerProfileAlwaysDiscloseExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
						
			// 3. Fill in the 'Message', 'Number of Samples' field and click on 'Contact Supplier Now' button.
			InquiryForm_Action.FillInMessage_NoOfSamples_ClickContactSuppNowBtn(dataMessage, dataNoOfSamples);
	 ...
	 */
	@DataProvider
	public Object[][] RFS_BuyerProfile_0002Data(){
