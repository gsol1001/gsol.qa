...
/**
 * This test case contain method to test user is able to login when username and password are valid. (CPP entry point)
 * 
 * @author Teng Shyh Wei
 *
 */
public class Login_0007 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Login_0001_TestResult;
	...
	@Test(dataProvider="Login_0007Data")
	public void Login_0007Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword,
		...
		try{		
			...
			// 1. In GSOL Homepage, click on the "Login" button from any of the following entry point:
