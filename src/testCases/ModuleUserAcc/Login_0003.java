 ...
 * @TestCaseID 1014 / 2C
 * @TestArea Login
 * @TestScenarioDesc User is unable to login when username is invalid and password is invalid
 * @TestStep
 * 
 ...
 * 		   - Global Navigation
 * 		   - CPP
 * 		2. Fill in "E-mail Address (or Username)" and "Password" field with invalid email (autoqa_inv1007@gmail.com) and invalid password (asdf8765).
...
/**
 * This test case contain method to test user is unable to login when username is invalid and password is invalid
 * @author Teng Shyh Wei
 *
 */
public class Login_0003 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Login_0003_TestResult;
	...
	@Test(dataProvider="Login_0003Data")
	public void Login_0003Test(String dataTestCaseName, String dataUsername, String dataPassword) throws Exception{
		...
		try{		
			...
			// 2. Fill in "E-mail Address (or Username)" and "Password" field with invalid email and invalid password.      
