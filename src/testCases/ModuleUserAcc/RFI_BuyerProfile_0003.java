 ...
 * 		3. Fill in the 'Message' field and click on 'Contact Supplier Now' button.
 * 		4. Repeat Step 1 - 3 for RFS form.
 * 
...
/**
 * This test case contain method to test Buyer Profile section - always not disclose
 * @author Teng Shyh Wei
 *
 */
public class RFI_BuyerProfile_0003 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFI_BuyerProfile_0003_TestResult;
	...
	@Test(dataProvider="RFI_BuyerProfile_0003Data")
	public void RFI_BuyerProfile_0003Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			// 3. Fill in the 'Message' field and click on 'Contact Supplier Now' button, verify that RFI Confirmation page is displayed.
			InquiryForm_Action.FillInMessage_ClickContactSuppNowBtn(dataMessage);
			...
			// 4. Repeat Step 1 - 3 for RFS form.
			// Please refer to RFS_BuyerProfile_0003.java					
	 ...
	 */
	@DataProvider
	public Object[][] RFI_BuyerProfile_0003Data(){
