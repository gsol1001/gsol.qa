/**
 * This class contains a method for RFS Buyer Profile
 * Created: Fri 28 Aug 2015
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2015/08/28
 * 
 * @TestCaseID 26F
 ...
 * 
 * 		1. As a logged in user, 'request for sample' for any product(s) and go to RFS form.
 ...
 * 		5. Fill in the 'Message' field and unchecked the "Remember my preference" checkbox. 
 * 		6. Click on 'Contact Supplier Now' button.
 * 		7. Repeat Step 1 - 4.
 * 		8. Select 'No, do not send this time' option in the Buyer Profile section.
 * 		9. Fill in the 'Message' field and unchecked the "Remember my preference" checkbox.
 * 		10. Click on 'Contact Supplier Now' button.
 * 		11. Repeat Step 1 - 2.
 * 		12. Verify that option 'No, do not send this time' is now checked as default.
 ...
 *
 */
public class RFS_BuyerProfile_0001 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = RFS_BuyerProfile_0001_TestResult;		
	...
	@Test(dataProvider="RFS_BuyerProfile_0001Data")
	public void RFS_BuyerProfile_0001Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
			String dataSearchKeyword,
			String dataMessage,
			String dataNoOfSamples,
			String dataBuyerProfile,
			String dataRememberMyPref) throws Exception{
		...
		try{		
			...
			// 5. Fill in the 'Message', 'Number of Samples' field and unchecked the "Remember my preference" checkbox.
			InquiryForm_Action.FillInMessage_NoOfSamples_RememberMyPrefChkbx(dataMessage, dataNoOfSamples, dataRememberMyPref);
			
			// To verify "Remember my preference" checkbox is not selected.
			InquiryForm_Page.check_rmbMyPrefChkbxNotSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
		...
		//	ProductInquiry_Action.ExecuteReqForSample_SglVerPdt(dataSearchKeyword);
			ProductInquiry_Action.ExecuteReqForSample_SglVerPdtAgain(dataSearchKeyword);
			
			// To verify same expected result as step 1 - 4.
			// To verify RFS form is displayed.
			// To verify radio button and checkbox options are available in the Buyer Profile section.
			// To verify option 'Yes, include my Buyer Profile for this inquiry' is checked as default.
			// To verify checkbox 'Remember my preference' is checked as default.
			InquiryForm_Page.check_sameExpResultAsStep1to4(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			
			// 8. Select 'No, do not send this time' option in the Buyer Profile section.
			InquiryForm_Page.radbtn_selectBuyerProfile(dataBuyerProfile);
			
			// To verify 'No, do not send this time' option is selected in the Buyer Profile section.
			InquiryForm_Page.check_buyerProfile_radbtnNoIsSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 9. Fill in the 'Message', 'Number of Samples' field and unchecked the "Remember my preference" checkbox.
			InquiryForm_Action.FillInMessage_NoOfSamples_RememberMyPrefChkbx(dataMessage, dataNoOfSamples, dataRememberMyPref);
			
			// To verify 'Remember my preference' checkbox is not selected.
			InquiryForm_Page.check_rmbMyPrefChkbxIsUnchecked(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
		...
		//	ProductInquiry_Action.ExecuteReqForSample_SglVerPdt(dataSearchKeyword);
			...
			// To verify same expected result as step 1 - 2.
			// To verify RFS form is displayed.
			// To verify radio button and checkbox options are available in the Buyer Profile section.
			InquiryForm_Page.check_sameExpResultAsStep1to2(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			
			// 12. Verify that option 'No, do not send this time' is now checked as default.
			InquiryForm_Page.check_buyerProfile_radbtnNoCheckedAsDefault(FilePath_TestResult, TestCaseName, DataSet+1, testFail);						
	 ...
	 */
	@DataProvider
	public Object[][] RFS_BuyerProfile_0001Data(){
