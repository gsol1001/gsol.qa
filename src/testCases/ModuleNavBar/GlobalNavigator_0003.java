/**
 * This class contains a method to verified Global Nav for logged-in/cookied in SYP user
 * Created: Mon 06 Mar 2017
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2017/03/06
 * 
 * @TestCaseID 
 * @TestArea Global Nav for logged-in/cookied in SYP user
 * @TestScenarioDesc Global Nav for logged-in/cookied in SYP user
 * @TestStep
 * 
 ...
 * 		Password: abcd1234
 * 
 * 		1. As a logged in SYP user, go to GSOL PP page.
 * 		2. Mouseover the user's menu at Global Navigator.
 * 		3. Go to Supplier homepage.
 * 		4. Repeat step 2.
 * 
...
/**
 * This test case contain method to test Global Nav for logged-in/cookied in SYP user
 * @author Teng Shyh Wei
 *
 */
public class GlobalNavigator_0003 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = GlobalNavigator_0003_TestResult;
	 ...
	 */
	@Test(dataProvider="GlobalNavigator_0003Data")
	public void GlobalNavigator_0003Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		//	ProductInquiry_Action.ExecuteLoggedIn_GSOLPPEntryPoint(dataUsername, dataPassword, dataSearchKeyword);
			...
			// To verify My Product Alert, My Preferred Exhibitors, Private Supplier Catalog, User Profile and Logout button are displayed.
			GlobalNav_MenuBar.check_subMenuSYPUserAvailable(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] GlobalNavigator_0003Data(){
