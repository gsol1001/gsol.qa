...
/**
 * Contain method to test Global Nav for non logged-in user.
 * @author Teng Shyh Wei
 *
 */
public class GlobalNavigator_0001 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = GlobalNavigator_0001_TestResult;
	 ...
	 * @throws Exception
	 */
	@Test(dataProvider="GlobalNavigator_0001Data")
	public void GlobalNavigator_0001Test(String dataTestCaseName) throws Exception{
		...
		try{		
			...
			// 1. As a non-logged in user, go to any page in the Appendix A, verify the menu in Global Nav.
			// 2. Click on "Login" menu at Global Nav.
			...
			// 3. Repeat Step 1-2 for:
			// a. Click on "Register" menu, select "Buyer" at Global Nav.
			GlobalNav_MenuBar.menuBar_selectRegisterForBuyer();
			
			// To verify Registration page for buyer is displayed.
			BuyerRegistration_Page.check_buyerRegPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			driver.navigate().back();
			
			// b. Click on "Register" menu, select "Supplier" at Global Nav.
			GlobalNav_MenuBar.menuBar_selectRegisterForSupplier();
			...
			// c. "Messages" menu at Global Nav.
			GlobalNav_MenuBar.menuBar_clickMessages().click();
			
			// To verify Login page for Messaging Center is displayed.
			MessageCenter_Page.check_messageCenterLoginPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			driver.navigate().back();			
			
			// d. Click on "Inquiry Basket" icon at Global Nav.
	 ...
	 */
	@DataProvider
	public Object[][] GlobalNavigator_0001Data(){
