 ...
 * 		2. Under PATH + PA Link, verified that DOI message is not displayed.
 * 		3. Mouseover the user's menu at Global 
 * 
 ...
 *
 */
public class GlobalNavigator_0006 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = GlobalNavigator_0006_TestResult;
	 ...
	 */
	@Test(dataProvider="GlobalNavigator_0006Data")
	public void GlobalNavigator_0006Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		//	ProductInquiry_Action.ExecuteLoggedIn_GSOLPPEntryPoint(dataUsername, dataPassword, dataSearchKeyword);
			...
			GlobalNav_MenuBar.menuBar_clickResendEmailLink();
			...
			GlobalNav_MenuBar.check_DOIMsgChangedIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);			
	 ...
	 */
	@DataProvider
	public Object[][] GlobalNavigator_0006Data(){
