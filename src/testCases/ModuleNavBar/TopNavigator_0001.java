...
/**
 * This test case contain method to test Top Navigator for non logged-in user.
 * @author Teng Shyh Wei
 *
 */
public class TopNavigator_0001 extends SuiteBaseNavBar{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = TopNavigator_0001_TestResult;
	...
	@Test(dataProvider="TopNavigator_0001Data")
	public void TopNavigator_0001Test(String dataTestCaseName,
		...
		try{		
			...
			// 3. Mouse hover the Trade Shows link at Top Navigator. (Skip as maintenance by SITE team)
		...
		*/	
			...
			TopNav_MenuBar.check_productAlertsPageDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			driver.navigate().back();			
			
			// Click on Magazines sub menu
			TopNav_MenuBar.subMenu_selectMagazines();			
			switchToNewWindowOpened();					// Switch to new window opened
			TopNav_MenuBar.check_magazinesPageDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);		
	 ...
	 */
	@DataProvider
	public Object[][] TopNavigator_0001Data(){
