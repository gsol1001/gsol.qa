 ...
 *     	2. Click on "Subscribe Now" button on any eMag title (e.g: Electronics).
 * 
 ...
 *
 */
public class eMagSubscription_0001 extends SuiteBaseeMag{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = eMagSubscription_0001_TestResult;
	...
	@Test(dataProvider="eMagSubscription_0001Data")
	public void eMagSubscription_0001Test(
		...
		try{		
			...
			// 2. Click on 'Subscribe Now' button on any eMag title(e.g: Mobile Electronics)
			eMag_Preference_Page.btn_clickSubscribeNow().click();
			
			// To verify that the 'Subscribe Now button become '[tick]Subscribed'.
			eMag_Preference_Page.check_msgSubscribedWithIconTickExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] eMagSubscription_0001Data(){
