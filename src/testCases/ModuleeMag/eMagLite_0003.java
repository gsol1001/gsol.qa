 ...
 * @TestStep
 *  	
 *     	Pre-req: Subscribe to eMag Lite using autoqa_gsolnewxxxx@gmail.com.
 *     	
...
import pageObjects.eMag_Warning_Page;
 ...
 *
 */
public class eMagLite_0003 extends SuiteBaseeMag{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = eMagLite_0003_TestResult;
	...
	@Test(dataProvider="eMagLite_0003Data")
	public void eMagLite_000Test(String dataTestCaseName, 
		...
		try{		
			...
			// Pre-req: Subscribe to eMag Lite using autoqa_gsol1014@gmail.com.
			...
			// Verify that message "Registration required to process this request for this e-mail address" is displayed in red color font.
			eMag_Warning_Page.check_eMagWarningPageDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			eMag_Warning_Page.check_eMagWarningMsgDisplayedInRed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] eMagLite_0003Data(){
