...
/**
 * This test case contain method to test eMag subscription from eMag preference page. (L2 entry point)
 * @author Teng Shyh Wei
 *
 */
public class eMagSubscription_0005 extends SuiteBaseeMag{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = eMagSubscription_0005_TestResult;
	...
	@Test(dataProvider="eMagSubscription_0005Data")
	public void eMagSubscription_0005Test(
			String dataTestCaseName,
			String dataUsername,
			String dataPassword,
			String dataL2Keyword) throws Exception{
		...
		try{		
			...
			// As a logged in user, go to eMag Preference page, clean up all subscribed magazines.
			eMag_Preference_Action.ExecuteEmagPrefPage_ClearAllSubsCategory(dataUsername, dataPassword);			
			
			// 1. From the L2 entry points, click on the 'Subscribe' button in the eMag cross promotion (centrewell) section.
		//	ProductInquiry_Action.ExecuteEmagCrossPromotionL2_ClickSubscribeBtn(dataL2Keyword);
	 ...
	 */
	@DataProvider
	public Object[][] eMagSubscription_0005Data(){
