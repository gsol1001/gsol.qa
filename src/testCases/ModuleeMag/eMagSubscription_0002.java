...
/**
 * This test case contain method to test eMag subscription from eMag preference page.
 * @author Teng Shyh Wei
 *
 */
public class eMagSubscription_0002 extends SuiteBaseeMag{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = eMagSubscription_0002_TestResult;
	...
	@Test(dataProvider="eMagSubscription_0002Data")
	public void eMagSubscription_0002Test(
		...
		try{		
			...
			// 1. From any of the following entry points, click on the 'Subscribe' button in the eMag cross promotion (centrewell) section.
			// -L2, -L3, -L4, -KWS, -TP, -TCS			
			ProductListing_Page.btn_clickEmagSubscribe().click();	// KWS entry point
	 ...
	 */
	@DataProvider
	public Object[][] eMagSubscription_0002Data(){
