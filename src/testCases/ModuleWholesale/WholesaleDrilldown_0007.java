 ...
 * @TestScenarioDesc Compare Product (Wholesale L1 Drilldown entry point)
 * 
 * @TestStep
 * 
 *     	1. Go to Wholesale L1 Drilldown page
 *      2. Check the Verified PP section
 *      3. Check the Unverified PP section
 *      4. Click on the 'Compare Product' button on any Verified PPs
 *     
...
/**
 * This test case contain method to test 'Compare Product' button (Wholesale L1 Drilldown entry point).
 * @author Teng Shyh Wei
 *
 */
public class WholesaleDrilldown_0007 extends SuiteBaseRFI{
	 ...
	 */
	@Test(dataProvider="WholesaleDrilldown_0007Data")
	public void WholesaleDrilldown_0007Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword, 
		...
		try{
			...
			// To verify 'Compare Product' button is available in Verified PP section
			
			
			// 3. Check the Unverified PP section
			
			
			// To verify 'Compare product' button is NOT available in Unverified PP section
	 ...
	 */
	@DataProvider
	public Object[][] WholesaleDrilldown_0007Data(){
