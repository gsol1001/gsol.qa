 ...
 * @TestScenarioDesc 'Inquire Now' for Unverified PPs (Wholesale L1 Drilldown entry point)
 * 
 * @TestStep
 * 
 ...
 *     	2. Select some PPs from Unverified PP section
 *     	3. Click on the "Inquiry Now" button within the Unverified PP section.
...
/**
 * This test case contain method to test 'Inquire Now' for Unverified PPs (Wholesale L1 Drilldown entry point)
 * @author Teng Shyh Wei
 *
 */
public class WholesaleDrilldown_0002 extends SuiteBaseRFI{
	 ...
	 */
	@Test(dataProvider="WholesaleDrilldown_0002Data")
	public void WholesaleDrilldown_0002Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword, 
		...
		try{
			...
			// 2. Select some PPs from Unverified PP section
			WholesaleDrilldown_Page.chkbx_selectMultipleUnvPdt();
			
			// To verify PPs from Unverified PP section are selected.
			
			
			// 3. Click on the "Inquiry Now" button within the Unverified PP section.
			WholesaleDrilldown_Page.btn_clickInqNowForVerPdtAtInqBar();
	 ...
	 */
	@DataProvider
	public Object[][] WholesaleDrilldown_0002Data(){
