/**
 * This test case contain method to test Search function at the bottom search bar
 ...
 * @TestCaseID 2370
 * @TestArea Search
 * @TestScenarioDesc Perform Search at the bottom search bar.
 * @TestStep
 * 
 *     	1. As a non-logged in user, go to TCS listing page.
 *      2. Click on "View xxx Gallery" link.
 *      3. Do a search with the bottom search bar.
 * 
...
/**
 * This test case contain method to test Search at the bottom search bar.
 * @author Teng Shyh Wei
 *
 */
public class ProductionBug_0003 extends SuiteBaseBug{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductionBug_0003_TestResult;
	 ...
	 */
	@Test(dataProvider="ProductionBug_0003Data")
	public void ProductionBug_0003Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword, 
		...
		try{
        	...
        	// 1. As a non-logged in user, go to any TCS listing page.	
			ProductInquiry_Action.ExecuteTCSEntryPoint(dataSearchKeyword);		// TCS entry point
			
			// Switch to new window opened
			switchToNewWindowOpened();
			
			// To verify TCS listing page is displayed.
			TopChinaSuppliers_Page.check_TopChinaSuppliersPageDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// 2. Click on "View xxx Gallery" link.
			TopChinaSuppliers_Page.lnk_clickGalleryView().click();
			
			// To verify TCS page is in gallery view mode.
			
			
			// Do a search with the bottom search bar.
	 ...
	 */
	@DataProvider
	public Object[][] ProductionBug_0003Data(){
