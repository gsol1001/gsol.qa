/**
 * This test case contain method to test RFI Confirmation page.
 * Created: Wed 25 May 2016
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2016/05/25
 * 
 * @TestCaseID 2371
 * @TestArea RFI Confirmation page
 ...
 *		password: asdf9876
 * 
 *     	1. As a logged-in user, 'inquire now' for single verified products and go to RFI form.
 *     	2. Fill in all the relevant fields.
 *     	3. Clink on "Contact Supplier Now" button
 * 
 ...
 *
 */
public class ProductionBug_0004 extends SuiteBaseBug{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductionBug_0004_TestResult;
	 ...
	 */
	@Test(dataProvider="ProductionBug_0004Data")
	public void ProductionBug_0004Test(String dataTestCaseName, 
			String dataUsername, 
			String dataPassword, 
		...
		try{
        	...
        	// 1. As a logged in user, 'inquire now' for single verified product and go to RFI form.
    		...
    		RFIConfirmation_Action.check_PAUpsellSection_UpdateMeOnNewL4Cat_SubsNowBtnExists(
    	...
    	//	RFIConfirmation_Action.check_RFIUpsellSection_PdtSimilar_InqNowExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getL4Category);
			...
			// To verify RFI Inquiry Form is not available on the page.
    		RFIConfirmation_Page.check_RFIFormIsNotDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] ProductionBug_0004Data(){
