 ...
 * @TestScenarioDesc User is able to register when Emag=Y PA=Y Nof=Y
 * @TestStep
 * 
...
/**
 * This test case contain method to test user is able to register when eMag=Y PA=Y Nof=Y.
 * @author Teng Shyh Wei
 *
 */
public class Registration_0001 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0001_TestResult;
	...
	@Test(dataProvider="Registration_0001Data")
	public void Registration_0001Test(String dataTestCaseName, 
		...
		try{
			...
			// Store selected eMag title Name
		//	ArrayList<String> checkedeMagList = null;
		//	BuyerRegistration_Page.store_selectedEmagTitle(dataEmagTitle, checkedeMagList);
		...
		/*	WebDriverWait wait = new WebDriverWait(driver, 15);
    		List<WebElement> eMagTitleNameList = wait.
    				until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
    						By.xpath("//*[contains(@class, 'reg_mag mt10')]//*[@checked='']/parent::label")));	
    		
    		List<WebElement> eMagTitleNameList = driver.findElements(
    				By.xpath("//*[contains(@class, 'reg_mag mt10')]//*[@checked='']/parent::label"));
			...
			for (WebElement element : eMagTitleNameList){
				...
				// test
				Add_Log.info(element.getAttribute("value"));								
			}	*/		
			...
			// To verify there are suggested categories for the product keyword entered in Step 4.
			...
			RegConfirmation_Action.ExecuteRegConfPage_ReqSMCopy_PACatSelIsDisplayed(
					FilePath_TestResult, TestCaseName, DataSet+1, testFail, checkedCatNameList);
			
			RegistrationConfirmation_Page.check_regConfHeaderCopyExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataFirstName, dataBusinessEmail);
			RegistrationConfirmation_Page.check_copyTradeMatchExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			RegistrationConfirmation_Page.check_copyProductsInterestedExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			RegistrationConfirmation_Page.check_copyTradeShowsExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0001Data(){
