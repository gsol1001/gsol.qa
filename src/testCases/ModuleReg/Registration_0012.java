 ...
 *     	5. Make sure the Notification checkboxes are unchecked.
...
/**
 * This test case contain method to test user is able to register when eMag=N PA=Y Nof=N. (login page entry point)
 * @author Teng Shyh Wei
 *
 */
public class Registration_0012 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0012_TestResult;
	...
	@Test(dataProvider="Registration_0012Data")
	public void Registration_0012Test(String dataTestCaseName, 
		...
		try{		
			...
			LogIn_Page.lnk_clickRegisterNow().click();		// Login page entry point
			...
			Registration_Action.ExecuteReg_OnlyPATxtbxFilledUp(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataProductKeyword);
			
			// 6. Click on the "Register Now" button.
			BuyerRegistration_Page.btn_clickRegisterNow().click();
			
			// To verify Select Product Alert Categories page is displayed.
			// There are suggested categories for the product keywor entered in Step4.
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0012Data(){
