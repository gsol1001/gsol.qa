 ...
 * Created: Tue 21 Mar 2016
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2017/03/21
 * 
 * @TestCaseID 1O
 * @TestArea Registration
 * @TestScenarioDesc Registration from Maximum Categories page
 * @TestStep
 * 
 ...
 *     	4. Click on the "Register Now" link in the warning message.
...
/**
 * This test case contain method to test user is able to register from Maximum Categories page.
 * @author Teng Shyh Wei
 *
 */
public class Registration_0015 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0015_TestResult;
	...
	@Test(dataProvider="Registration_0015Data")
	public void Registration_0015Test(String dataTestCaseName, 
		...
		try{		
			...
			// 4. Click on the "Register Now" link in the warning message.
			PALite_EditCategories_Page.lnk_clickRegisterNow().click();
			...
			// 5. Fill up all the mandatory fields.
			// 6. Make sure all the eMag title checkboxes are checked.
			// 7. Make sure the Notification checkboxes are checked.
			...
			// Verified that there are suggested categories for the product keyword entered in Step3. 
			...
			// 9. Check on any category checkboxes which are different from the categories in pre-req.
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0015Data(){
