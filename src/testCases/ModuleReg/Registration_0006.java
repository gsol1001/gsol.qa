 ...
 * @TestScenarioDesc User is able to register when Emag=N PA=Y Nof=N
 * @TestStep
 * 
 ...
 *     	5. Uncheck the Notification checkboxes.
 *     	6. Click on the "Register Now" button.
 *     	7. Click on "Browser categories" tab and choose a category (e.g: Electronics) from "Choose an industry" dropdown list.
 *     	8. Check on any category checkboxes.
 *     	9. Click on "Go to Confirmation" button.
 *     	10. Click on the "OK" button in DOI reminder overlay.
...
/**
 * This test case contain method to test user is able to register when eMag=N PA=Y Nof=N
 * @author Teng Shyh Wei
 *
 */
public class Registration_0006 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0006_TestResult;
	...
	@Test(dataProvider="Registration_0006Data")
	public void Registration_0006Test(String dataTestCaseName, 
		...
		try{		
			...
			Registration_Action.ExecuteReg_eMag_PA_Notification_NotFilledUp(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// 7. Click on "Browse categories" tab and choose a category (e.g: Electronics) from "Choose an industry" dropdown list.
			PA_AddCategories_Action.ExecuteBrowseCategories_ChooseACategory();
			
			// To verify suggested categories for the category selected in Step 7 are displayed.
			...
			UserProfile_Action.check_notificationsPageDisplayed_AllNofChkbxNotSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0006Data(){
