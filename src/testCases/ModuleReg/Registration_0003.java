 ...
 * @TestScenarioDesc User is able to register when Emag=Y PA=N Nof=Y
 * @TestStep
 * 
...
/**
 * This test case contain method to test user is able to register when eMag=Y PA=N Nof=Y
 * @author Teng Shyh Wei
 *
 */
public class Registration_0003 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0003_TestResult;
	...
	@Test(dataProvider="Registration_0003Data")
	public void Registration_0003Test(String dataTestCaseName, 
		...
		try{
			...
			// 3. Check any eMag title checkbox (e.g: Electronics).
			// 4. Make sure the PA Alert field is blank.
			// 5. Make sure the Notification checkbox are checked.
			...
			Registration_Action.ExecuteReg_OnlyEmagNotification_FilledUp(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataEmagTitle);
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0003Data(){
