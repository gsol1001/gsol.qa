 ...
 * @TestScenarioDesc User is able to register when Emag=N PA=Y Nof=Y
 * @TestStep
 * 
 ...
 *     	7. Enter a product keyword in product keyword textbox (e.g: MP3).
 *     	8. Click on "Find Categories" button.
 *     	9. Check on any category checkboxes.
 *     	10. Click on "Go to Confirmation" button.
 *     	11. Click on the "OK" button in DOI reminder overlay.
 *     	12. Go to "User Profile" page.
 *     	13. Click on the "Notifications" link at the left nav.
 *     	14. Click on the "Sourcing Magazines" link at the left nav.
 *     	15. Click on the "Product Alert" link at the left nav.
 * 
...
/**
 * This test case contain method to test user is able to register when eMag=N PA=Y Nof=Y
 * @author Teng Shyh Wei
 *
 */
public class Registration_0005 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0005_TestResult;
	...
	@Test(dataProvider="Registration_0005Data")
	public void Registration_0005Test(String dataTestCaseName, 
			...
			String dataAddProductKeyword) throws Exception{
		...
		try{
			...
			// 2. Fill up all the mandatory fields. (use autoqa_gsolnewxxxx@gmail.com in Business E-mail field)
			// 3. Make sure all the eMag title checkboxes are unchecked.					
			// 4. Make sure the PA Alert field is blank.						
			// 5. Make sure the Notification checkboxes are checked.
			...
			// 7. Enter a product keyword in product keyword textbox (e.g: MP3).
			PA_AddCategories_Page.txtbx_enterProductKeyword().sendKeys(dataAddProductKeyword);
			
			// To verify Product keyword is entered in the textbox.
			PA_AddCategories_Page.check_pdtKeywordIsEntered(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataAddProductKeyword);
			
			
			// 8. Click on "Find Matching Categories" button.
			PA_AddCategories_Page.btn_clickFindMatchingCategories();
			
			// To verify suggested categories for the product keyword entered in Step 7 are displayed.
			...
			// To verify "You've also requested sourcing magazines." statement is NOT exists
			// To verify the PA categories selected in Step 9 are displayed.
			RegConfirmation_Action.ExecuteRegConfPage_NoReqSMCopy_PACatSelIsDisplayed(
					FilePath_TestResult, TestCaseName, DataSet+1, testFail, checkedCatNameList);
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0005Data(){
