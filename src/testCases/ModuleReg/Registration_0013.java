...
/**
 * This test case contain method to test user is able to register when eMag=N PA=Y Nof=Y. (PA Marketing page entry point)
 * @author Teng Shyh Wei
 *
 */
public class Registration_0013 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0013_TestResult;
	...
	@Test(dataProvider="Registration_0013Data")
	public void Registration_0013Test(String dataTestCaseName, 
		...
		try{		
			...
			LogIn_Page.lnk_clickRegisterNow().click();
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0013Data(){
