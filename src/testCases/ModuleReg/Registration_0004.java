 ...
 * @TestScenarioDesc User is able to register when Emag=Y PA=N Nof=N
 * @TestStep
 * 
...
/**
 * This test case contain method to test user is able to register when eMag=Y PA=N Nof=N
 * @author Teng Shyh Wei
 *
 */
public class Registration_0004 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0004_TestResult;
	...
	@Test(dataProvider="Registration_0004Data")
	public void Registration_0004Test(String dataTestCaseName, 
		...
		try{
			...
			Registration_Action.ExecuteReg_OnlyEmagTitleChkbxFilledUp(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataEmagTitle);
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0004Data(){
