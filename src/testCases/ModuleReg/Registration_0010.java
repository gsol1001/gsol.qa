 ...
 * @TestScenarioDesc User is able to register when email entered is a eMag Lite subsciber
 * @TestStep
 * 
 ...
 *     	3. Check any eMag title checkbox (e.g: Electronics) which is different from pre-req.
...
/**
 * This test case contain method to test user is able to register when email entered is a eMag Lite subscriber.
 * @author Teng Shyh Wei
 *
 */
public class Registration_0010 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0010_TestResult;
	...
	@Test(dataProvider="Registration_0010Data")
	public void Registration_0010Test(String dataTestCaseName, 
		...
		try{		
			...
			// Pre-req: Subscribe to eMag Lite using autoqa_gsolnewxxxx@gmail.com. Note down the eMag titles subscribed.
			
			// Go to eMag Lite form page.
			// https://login.qa.globalsources.com/sso/GeneralManager?action=RegisterEmagCheck&validate=false&pi_proj=10AWVL
    	...
    	*/	
    	...
    	/*	List<WebElement> eMagTitleNameList = wait.
			...
			// To verify the eMag title selected in pre-req as well as Step 3 are displayed in "Magazine(s) Subscribed" section.
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0010Data(){
