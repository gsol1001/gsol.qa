 ...
 * @TestScenarioDesc User is able to register when Emag=Y PA=Y Nof=N
 * @TestStep
 * 
...
/**
 * This test case contain method to test user is able to register when eMag=Y PA=Y Nof=N
 * @author Teng Shyh Wei
 *
 */
public class Registration_0002 extends SuiteBaseReg{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Registration_0002_TestResult;
	...
	@Test(dataProvider="Registration_0002Data")
	public void Registration_0002Test(String dataTestCaseName, 
		...
		try{
			...
			// 3. Check any eMag title checkbox (e.g: Electronics).
			// 4. Enter a product keyword in PA textbox (e.g: MP3).
			// 5. Uncheck the notification chekboxes.
			...
			// To verify the eMag title checkbox is checked			
			// To verify the product keyword is entered in the textbox
			// To verify the notification checkbox are unchecked.
			Registration_Action.ExecuteReg_OnlyEmagPA_FilledUp(
    	...
    	/*	List<WebElement> eMagTitleNameList = wait.
    				until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
    						By.xpath("//*[equalsIgnoreCase(@class, 'reg_mag mt10')]/li/label")));
    	...
    	*/	
			...
			// To verify Select Product Alert Categories page is displayed. There are suggested categories for the product keyword entered in Step 4.
			...
			// To verify the "You've also requested sourcing magazines." statement exists 
	 ...
	 */
	@DataProvider
	public Object[][] Registration_0002Data(){
