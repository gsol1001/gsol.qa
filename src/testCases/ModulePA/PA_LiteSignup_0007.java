...
/**
 * This test case contain method to test PA Lite signup from PA Enhanced Entrance (L3 entry point)
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0007 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0007_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0007Data")
	public void PA_LiteSignup_0007Test(String dataTestCaseName, 
		...
		try{		
			...
			ProductInquiry_Action.ExecuteL3EntryPoint(dataCategoryKeyword);		// L3 entry point
			...
			// To verify Select Product Alert Categories page is displayed. There are suggested categories based on the keyword in L3, TP or Unverified PP.
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0007Data(){
