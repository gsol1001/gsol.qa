 ...
 * @TestScenarioDesc PA Lite signup from PA Enhanced Entrance
 * @TestStep
 * 
 ...
 *     	   - TP
 *     	   - Unverified PP page
 *     	2. Enter a brand new email address in the email textbox and click on "Subscribe" button.
 *     	3. Check on any category checkboxes.
 *     	4. Click on "Subscribe Now" button.
 *     
...
/**
 * This test case contain method to test PA Lite signup from PA Enhanced Entrance (TP entry point)
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0024 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0024_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0024Data")
	public void PA_LiteSignup_0024Test(String dataTestCaseName, 
		...
		//	TopProducts_Page.lnk_clickGalleryView().click();	// MR#45402 Gallery View link is removed
			...
			ProductListing_Page.check_txtbxEmailAddrBesideEnhancedEntranceLink(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
					
			// Store the 2nd window handle
			String PAHandle = driver.getWindowHandle();
			
			// 2. Enter a brand new email address (autoqa_gsolnewxxxx@gmail.com) in the email textbox and click on "Subscribe" button.
			PALite_Signup_Action.ExecutePAEnhancedEntrance_EnterEmailAddr_ClickSubscribeBtn(dataEmailAddress);
			
			// Switch to new window opened.
			switchToNewWindowOpened();
			
			// To verify Select Product Alert Categories page is displayed. 
			// To verify there are suggested categories based on the keyword in L3, TP or Unverified PP.
			...
			// 4. Click on "Go to Confirmation" button.
			...
			PALite_Confirmation_Action.ExecutePALiteConfPage_UpgUpsellSec_UpTo10CatSelAreDisplayed(
					FilePath_TestResult, TestCaseName, DataSet+1, testFail);
						
			// Switch back to PA window
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0024Data(){
