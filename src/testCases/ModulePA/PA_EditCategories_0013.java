 ...
 * 		password: 
 * 		
 * 		1. Inquire for multiple categories products and go to RFI form.
 * 		2. Fill in the relevant fields and make sure the PA upsell checkbox is unchecked.
 * 		3. Click on the "Contact Supplier Now" button.
 * 		4. Make sure the L4 category checkboxes are checked and click on "Subscribe Now" button.
 * 
 ...
 *
 */
public class PA_EditCategories_0013 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0013_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0013Data")
	public void PA_EditCategories_0013Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			// 1. As a logged in user, clean up subscribed PA category, Inquire for multiple categories products and go to RFI form.
			ProductInquiry_Action.ExecuteLoggedIn_CleanUpPA_InqMulCatPdt(dataUsername, dataPassword, dataSearchKeyword);
			
			// To verify the RFI form is displayed. Verify that user's contact details are pre-populated and 
			// the PA upsell copy is "I want e-mail updates when new products are posted in the categories I'm inquiring on."
			...
			// 2. Fill in the relevant fields and make sure the PA upsell checkbox is unchecked
        	InquiryForm_Action.ExecuteLI1_PdtInq_InqNow_MulVerPdt_MulCat_Info(dataSubject, 
        			dataExpOrderQuantity, dataRequestFor, dataMessage, dataPAUpsell);
			...
			// To verify the RFI confirmation page is displayed. Verify that the copy for PA upsell section:
			// - Update me on new products
			// - Receive Product Alert in these categories: 
			// - [List the inquired L4 categories (checkboxes are pre-checked)]
			...
			RFIConfirmation_Page.check_PASection_ReceivePAExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
    		...
    		List<WebElement> categoriesNameList = wait.
    				until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
    						By.xpath("//*[contains(@class, 'form_PA_cat form_PA_catCheck')]//li")));
			...
			// 4 . Make sure the L4 categories chkbx is checked and click on 'Subscribe Now' button
			RFIConfirmation_Page.btn_clickSubscribeNow().click();
			
			// To verify Product Alert Category Confirmation page is displayed and the categories are added to Product Alert.
			PA_CategoryConf_Page.check_PACategoryConfPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			PA_CategoryConf_Page.check_categoryAddedToPdtAlert(FilePath_TestResult, TestCaseName, DataSet+1, testFail, checkedCatNameList);
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0013Data(){
