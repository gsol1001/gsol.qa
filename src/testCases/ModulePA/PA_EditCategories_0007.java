 ...
 * @TestStep
 * 
 * 		1. As a new user, inquire for multiple categories products and go to RFI form.
 * 		2. Fill in the relevant fields and make sure the PA upsell checkbox is checked.
 * 		3. Click on the "Continue to Next Step" button.
 * 		4. Fill in the "Create a Password" and "Re-enter Password" fields with valid username and password 
 * 		   and click on "Send Your Inquiry Now" button.
 * 
...
/**
 * This test case contain method to test PA edit categories from RFI
 * @author Teng Shyh Wei
 *
 */
public class PA_EditCategories_0007 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath = TestCaseListExcel_SuitePA_001_TestData;
		FilePath_TestResult = PA_EditCategories_0007_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0007Data")
	public void PA_EditCategories_0007Test(String dataTestCaseName,
		...
		try{		
			...
			// - Hi First Name, please check your e-mail, sent to xyz@xyz.com
			// - [new PA box] you must click on the link in the e-mail we'sent you to activate your request.
			// - Category(s) for your Product Alert: {Inquired L4 category} (display categories 2 in a row)
			...
			RFIConfirmation_Page.check_PASection_CheckEmailExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataFirstName, dataBusinessEmail);
			RFIConfirmation_Page.check_PASection_NewPABoxExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0007Data(){
