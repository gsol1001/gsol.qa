...
/**
 * This test case contain method to test PA edit categories from PA cross promotion (centrewell) (L4 entry point)
 * @author Teng Shyh Wei
 *
 */
public class PA_EditCategories_0003 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0003_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0003Data")
	public void PA_EditCategories_0003Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			ProductInquiry_Action.ExecuteL4EntryPoint(dataProductKeyword);		// L4 entry point
			...
			// 3. Click on "Add Categories" button.
			ProductListing_Page.btn_clickAddCategories().click();
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0003Data(){
