...
/**
 * This test case contain method to test PA edit categories from PA cross promotion (centrewell) (New Products entry point)
 * @author Teng Shyh Wei
 *
 */
public class PA_EditCategories_0017 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0017_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0017Data")
	public void PA_EditCategories_0017Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			ProductInquiry_Action.ExecuteNewProductsEntryPoint(dataProductKeyword);		// New Products entry point
			
			// Switch to new window opened.
			switchToNewWindowOpened();
			
			// Select L1 or L2 category based on value from input data.
			NewProducts_Page.lnk_clickCategoryKeyword(dataCategoryKeyword).click();
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0017Data(){
