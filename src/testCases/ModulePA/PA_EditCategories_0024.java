 ...
 *     	   - Article
 *     	   - GSOL PP page
 *     	 2. Go to PA homepage, verify that the category is added to the PA categories.
 * 
...
/**
 * This test case contain method to test PA edit categories from PA Enhanced Entrance (GSOL PP page entry point).
 * @author Teng Shyh Wei
 *
 */
public class PA_EditCategories_0024 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0024_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0024Data")
	public void PA_EditCategories_0024Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			ProductListing_Page.img_clickOnRolloverLargerImage();	// GSOL PP page entry point
			...
			PALite_Signup_Action.ExecutePAEnhancedEntrance_ViewLatesPdtLinkExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			WebElement element = driver.findElement(By.xpath("//*[contains(@class, 'path mt5')]//a[5]"));
			String selectedCategory = element.getText();
			Add_Log.info("Print selected category ::" + selectedCategory);
			...
			PA_Home_Page.check_categoryIsAddedToColumnPAHomepage(FilePath_TestResult, TestCaseName, DataSet+1, testFail, selectedCategory);
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0024Data(){
