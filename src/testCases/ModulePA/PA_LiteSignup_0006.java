 ...
 * @TestScenarioDesc PA Lite signup from eMag Lite confirmation page
 * @TestStep
 * 
 *     	1. Subscribe to eMag Lite and go to eMag Lite confirmation page.
 *     	2. Enter a brand new email address in the PA upsell section textbox and click on "Subscribe" button.
 *     	3. Enter a product keyword in product keyword textbox (e.g: MP3) and click on "Find Categories" button.
 *     	4. Check on any category checkboxes more than 10 times.
 *     	5. Click on "Subscribe Now" button.
 *     	6. Click on "Close" button in the error message pop-up window.
 *     	7. Remove some of the categories by clicking on the dustbin sign in the selected categories column until the categories selected are less than 10.
 *     	8. Click on "Subscribe Now" button.
 *     
...
/**
 * This test case contain method to test PA Lite signup from eMag Lite confirmation page.
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0006 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0006_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0006Data")
	public void PA_LiteSignup_0006Test(String dataTestCaseName, 
		...
		try{		
			...
			// Subscribe to eMag Lite and go to eMag Lite confirmation page.
			// Go to eMag Lite form page.
			driver.get(Param.getProperty("eMagLiteFormURL"));
			
			eMagLite_Form_Action.ExecuteSubscribeToEmagLite(driver, dataPrefEmagTitle, dataBusinessEmail, 
					dataFirstName, dataLastName, dataCompName, dataCountryTerritory);
			...
			// 2. Enter a brand new email address (autoqa_gsolnewxxxx@gmail.com) in the PA upsell section textbox and click on "Subscribe" button.
			eMagLite_Confirmation_Action.ExecuteEnterBusinessEmail_ClickSubscribeBtn(dataBusinessEmail);			
			
			// Select Product Alert Categories page is displayed. There is no suggested categories.
			...
			PA_AddCategories_Page.chkbx_selectMoreThan10Categories();
			...
			PA_AddCategories_Page.check_msgExceed10CatSubs_ClickOKToAccept(FilePath_TestResult, TestCaseName, DataSet+1, testFail);

			// 6. Click on "Close" button in the error message pop-up window.
			PA_AddCategories_Page.btn_clickClose().click();
			
			// To verify Error message pop-up window is closed.
			PA_AddCategories_Page.check_errorMsgPopupWindowIsClosed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 7. Remove some of the categories by clicking on the dustbin sign in the selected categories column 
			// until the categories selected are less than 10.
			PA_AddCategories_Page.icon_clickDustbin();
			
			// To verify the categories are removed.
			PA_AddCategories_Page.check_selCategoriesNotMoreThan10(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// and up to 10 PA categories selected in Step 4-7 are displayed.
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0006Data(){
