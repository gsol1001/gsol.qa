 ...
 *
 */
public class PA_EditCategories_0009 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0009_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0009Data")
	public void PA_EditCategories_0009Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{					
			...
			// To verify the RFI form is displayed. Verify that user's contact details are pre-populated 
			// and PA upsell copy is "I want e-mail updates when new products are posted in the categories I'm inquiring on."
			...
			// To verify the the relevant fields are filled up and the PA upsell checkbox is checked.
			...
			// - Category(s) below has been added to your Product Alert: {Inquired L4 category} (display categories 2 in a row)
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0009Data(){
