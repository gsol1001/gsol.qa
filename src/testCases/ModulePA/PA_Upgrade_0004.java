 ...
 * @TestCaseID 1048/ 6E
 * @TestArea PA Upgrade
 * @TestScenarioDesc PA upgrade from PA upgrade from Forget Password
 * @TestStep
 * 
 ...
 *     	   - Min Login page
 *     	2. In "E-mail Address" field, enter a valid email address which is used in pre-req and click on "Submit" button.
 ...
 *     	9. Go to "User Profile" page.
 *     	10. Click on the "Notifications" link at the left nav.
 *     	11. Click on the "Sourcing Magazines" link at the left nav.
 *     	12. Click on the "Product Alert" link at the left nav.
 *     
...
/**
 * This test case contain method to test PA upgrade from PA Forget Password.
 * @author Teng Shyh Wei
 *
 */
public class PA_Upgrade_0004 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_Upgrade_0004_TestResult;
	...
	@Test(dataProvider="PA_Upgrade_0004Data")
	public void PA_Upgrade_0004Test(String dataTestCaseName, 
		...
		try{		
			...
			// 1. Subscribe to PA Lite using autoqa_gsolnewxxxx@gmail.com
		//	PA_LiteSignup_Action.ExecutePALiteSignup(dataBusinessEmail);
		...
		//	PA_AddCategories_Action.ExecuteBrowserCategories_ChooseACategory();
        	...
        	// - Login page with 'The Login Name or E-mail and Password do not match.' error
        	// - Min Login page
			ForgetPassword_Action.ExecuteGoToLoginPage_ClickForgotPasswordLink();
			...
			ForgetPassword_Action.ExecuteEnterEmailAddr_ClickSubmitBtn(dataBusinessEmail);
	 ...
	 */
	@DataProvider
	public Object[][] PA_Upgrade_0004Data(){
