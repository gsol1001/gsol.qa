 ...
 * @TestScenarioDesc PA Lite signup from PA inline banner
 * @TestStep
 * 
 *     	1. From any of the following entry points, enter a brand new email address (autoqa_gsolnewxxxx@gmail.com) 
 *         in the PA Inline Banner textbox and click on "Subscribe" button.
 *     	   - Browse Categories page
 *     	   - Country Sourcing Categories page
 *     	   - Product Vertical Homepages
 *     	2. Enter a product keyword in product keyword textbox (e.g: MP3) and click on "Find Categories" button.
...
/**
 * This test case contain method to test PA Lite signup from inline banner
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0004 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0004_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0004Data")
	public void PA_LiteSignup_0004Test(String dataTestCaseName, 
		...
		try{		
			...
			// 1. From any of the following entry points, enter a brand new email address (autoqa_gsolnewxxx@gmail.com) 
			// in the PA Inline Banner textbox and click on "Subscribe" button.
			// - Browse Categories page
			// - Country Sourcing Categories page
			// - Product Vertical Homepages
		...
		//	Home_Page.drpdwn_selectBrowseCategories();
			...
			// Enter an brand new email address in the PA Inline Banner textbox and click on "Subscribe" button.
			BrowseProductCategories_Action.ExecuteEnterEmailAddr_ClickSubscribeBtn(dataEmailAddress);
			...
			// 4. Click on "Browse categories" tab and choose a category (e.g: Electronics) from "Choose an industry" dropdown list.
			PA_AddCategories_Action.ExecuteBrowseCategories_ChooseACategory();
			
			// To verify suggested categories for the category selected are displayed.
			...
			// and up to 10 PA categories selected in Step 3-5 are displayed.
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0004Data(){
