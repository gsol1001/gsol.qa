 ...
 * Created: Thu 21 Jan 2015
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2016/01/21
 * 
 * @TestCaseID 5Z
 * @TestArea PA Edit Categories
 * @TestScenarioDesc PA edit categories from RFI
 * @TestStep
 * 
 ...
 * 		1. Inquire for single category product(s) and go to RFI form
 * 		2. Fill in the relevant fields.
 * 		3. Click on the "Contact Supplier Now" button
 * 		4. Click on the "Add other categories to my Product Alert" link in Mini Marketing section
 * 		5. Click on "Browser categories" tab and choose a category (e.g: Electronics) from "Choose an industry" dropdown list.
 * 		6. Check on any category checkboxes.
 ...
 *
 */
public class PA_EditCategories_0025 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0025_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0025Data")
	public void PA_EditCategories_0025Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			// 1. As a logged in user, clean up subscribed category, Inquire for single category product(s) and go to RFI form.
			ProductInquiry_Action.ExecuteLoggedIn_CleanUpPA_InqSglVerPdt(dataUsername, dataPassword, dataSearchKeyword);
			...
			// 2. Fill in the relevant fields and check the PA upsell checkbox. 
			...
			// - Category(s) below has been added to your Product Alert: {Inquired L4 category}
			...
			// To verify Mini Marketing box "Add other categories to my Product Alert" link is displayed
			RFIConfirmation_Page.check_miniMarketingBoxSection_AddOtherCategoriesToMyPA(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
						
			// 4. Click on the "Add other categories to my Product Alert" link in Mini Marketing section
			RFIConfirmation_Page.lnk_clickAddOtherCategoriesToMyPA().click();
			
			// To verify PA Add Categories page is displayed. There is no suggested categories.
		...
		//	PA_EditCategories_Action.ExecutePAEditCatPageDisplayed_SuggCatNotAvailable(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// 5. Click on "Browser categories" tab and choose a category (e.g.: Mobile Electronics) from "Choose an industry" dropdown list.
			...
			for (WebElement element1 : categoriesNameList2){
				Add_Log.info("checkedCatNameList2 ::" + element1.getText());
				checkedCatNameList2.add(element1.getText());
			}	
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0025Data(){
