 ...
 * Created: Tue 05 Jan 2016
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2015/01/05
 * 
 * @TestCaseID 4N
...
import appModules.NewProducts_Action;
...
/**
 * This test case contain method to test PA Lite signup from PA cross promotion (centrewell) (New Product entry point).
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0016 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0016_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0016Data")
	public void PA_LiteSignup_0016Test(String dataTestCaseName, 
		...
		try{		
			...
			ProductInquiry_Action.ExecuteNewProductsEntryPoint(dataSearchKeyword);	// New Product entry point
			...
			NewProducts_Action.ExecuteEnterBusinessEmail_ClickSubscribeBtn(dataBusinessEmail);
			
			
			// To verify Select Product Alert Categories page is displayed. There is no suggested categories if the entry point is New Product.
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0016Data(){
