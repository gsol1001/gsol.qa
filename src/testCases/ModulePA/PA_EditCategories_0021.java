 ...
 *     	3. Click on "Add Categories" button.
 * 
...
import appModules.NewsInquiry_Action;
...
/**
 * This test case contain method to test PA edit categories from PA cross promotion (centrewell) (Article entry point).
 * @author Teng Shyh Wei
 *
 */
public class PA_EditCategories_0021 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0021_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0021Data")
	public void PA_EditCategories_0021Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			NewsInquiry_Action.ExecuteArticleEntryPoint_ClickArticleTitle(dataSearchKeyword);		// Article entry point			
						
			// To verify the page is displayed. 
			// There are suggested categories in PA cross promotion (centrewell) section with the first category's checkbox is checked.
			NewsListing_Page.check_suggCatPACrossPromotionExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			NewsListing_Page.check_firstCategoryChkbxSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 2. Check on any category checkboxes.
			NewsListing_Page.chkbx_select2ndCategory().click();
			
			// To verify the categories checkboxes are checked.
			NewsListing_Page.check_secondCategoryChkbxSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 3. Click on "Add Categories" button.
			NewsListing_Page.btn_clickAddCategories().click();
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0021Data(){
