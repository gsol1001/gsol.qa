 ...
 *     	1. As a PA Lite user, inquire for single category product(s) and go to RFI form.
 ...
 *
 */
public class PA_Upgrade_0001 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_Upgrade_0001_TestResult;
	...
	@Test(dataProvider="PA_Upgrade_0001Data")
	public void PA_Upgrade_0001Test(String dataTestCaseName, 
		...
		//	PA_AddCategories_Action.ExecuteBrowserCategories_ChooseACategory();
			...
			// 1. As a PA Lite user, inquire for single category product(s) and go to RFI form.
			PALite_Confirmation_Action.ExecuteEnterSearchKeyword_ClickSearchBtn(dataSearchKeyword);
	 ...
	 */
	@DataProvider
	public Object[][] PA_Upgrade_0001Data(){
