 ...
 * Created: Fri 08 Jan 2016
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2016/01/08
 * 
 * @TestCaseID 4Z
...
/**
 * This test case contain method to test PA Lite signup from PA Enhanced Entrance (Article entry point).
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0026 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0026_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0026Data")
	public void PA_LiteSignup_0026Test(
		...
		try{		
			...
			NewsListing_Page.lnk_clickUpdateMeOnNewProducts().click();
			
			// To verify Email address textbox is displayed beside Enhanced Entrance link.
			NewsListing_Page.check_txtbxEmailAddrBesideEnhancedEntranceLink(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 2. Enter a brand new email address in the email textbox and click on "Subscribe" button.
			NewsInquiry_Action.ExecutePAEnhancedEntrance_EnterEmailAddr_ClickSubscribeBtn(dataBusinessEmail);
			...
			PALite_Signup_Action.ExecutePAEnhancedEntrance_ConfCopyMessageExists(
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0026Data(){
