 ...
 * 		password: 
 * 		
 * 		1. Inquire for single categories products and go to RFI form.
 ...
 *
 */
public class PA_EditCategories_0012 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0012_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0012Data")
	public void PA_EditCategories_0012Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		//	ProductInquiry_Action.ExecuteLoggedIn_CleanUpPA_InqSglVerPdt(dataUsername, dataPassword, dataSearchKeyword);
			...
			// RFI form is displayed. Verify that user's contact details are pre-populated and 
			// the PA upsell copy 'I want e-mail updates when new {Inquired L4 category} are available.' is seen
			...
			// To verify Product Alert Category Confirmation page is displayed and the category is added to Product Alert.
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0012Data(){
