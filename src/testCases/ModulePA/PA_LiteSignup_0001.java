 ...
 * Created: Mon 31 Aug 2015
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2015/08/31
 * 
 * @TestCaseID 1018 / 4A
 * @TestArea PA Lite Signup
 * @TestScenarioDesc PA Lite signup from Get Notified section
 * @TestStep
 *  	
 *     	1. From any of the entry points in Appendix A, enter a brand new email address in the 
 *         Get Notified section textbox and click on "Subscribe" button.
...
/**
 * This test case contain method to test PA Lite signup from Get Notified section.
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0001 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0001_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0001Data")
	public void PA_LiteSignup_0001Test(String dataTestCaseName, 
			String dataEmailAddress,
			String dataProductKeyword, 
			String dataSecondProductKeyword) throws Exception{
		...
		try{		
			...
			// 1. From any of the entry points in Appendix A, enter a brand new email address in the 
			//    Get Notified section textbox and click on "Subscribe" button.
			Home_Page.txtbx_enterGetNotifiedEmailAddress().sendKeys(dataEmailAddress);
			...
			// 4. Repeat Step 2-3 using another keyword.
			PA_AddCategories_Action.ExecuteEnterPdtKeyword_ClickFindMatchingCatBtn(dataSecondProductKeyword);
			PA_AddCategories_Page.chkbx_selectCategoriesSuggestions().click();
			
			// To verify same expected results as step 2-3.
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0001Data(){
