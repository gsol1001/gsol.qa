 ...
 *     	3. Enter a product keyword in product keyword textbox and click on 'Find Matching Categories' button.
...
/**
 * This test case contain method to test PA Lite signup from PA Enhanced Entrance (Unverified PP page entry point)
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0025 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0025_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0025Data")
	public void PA_LiteSignup_0025Test(String dataTestCaseName, 
		...
		try{		
			...
			// Click on the PA Enhanced Entrance 'Get e-mail alerts on latest products' link.
			UnvSupplierPP_Page.lnk_clickPAEnhancedEntrance();
			
			// To verify Email address textbox is displayed beside Enhanced Entrance link.
			UnvSupplierPP_Page.check_txtbxEmailAddrBesideEnhancedEntranceLink(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
					
			// 2. Enter a brand new email address in the email textbox and click on "Subscribe" button.			
			UnvSupplierPP_Page.txtbx_enterPAEnhancedEntrance().sendKeys(dataBusinessEmail);
			UnvSupplierPP_Page.btn_clickSubscribe();
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0025Data(){
