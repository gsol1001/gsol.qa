 ...
 *
 */
public class PA_EditCategories_0011 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0011_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0011Data")
	public void PA_EditCategories_0011Test(String dataTestCaseName,
		...
		try{		
			...
			// 2. Fill in the relevant fields and unchecked the PA upsell checkbox.
    		InquiryForm_Action.ExecuteNL1_PdtInq_InqNow_MulVerPdt_MulCat_Info(dataCcEmailAddress, dataSubject, 
    				dataExpOrderQuantity, dataRequestFor, dataMessage, dataTitle, dataFirstName, dataLastName, 
    				dataBusinessEmail, dataCompName, dataCountryTerritory, dataTelephoneNumber, dataRadbtnCompWebsiteURL, dataTxtbxCompWebsiteURL, dataPAUpsell);
    		...
    		// RFI confirmation page is displayed. Verify that the copy for PA upsell section:
    		// - Update me on new products
    		// - Hi First Name, as a registered user, you are eligible for free Product Alert e-mail updates.
    		// - [List the inquired L4 category (max 6, 3 in a row, checkboxes are pre-checked)]    	
    		...
    		// To verify Product Alert Category Confirmation page is displayed and 
        	...
        	PA_CategoryConf_Page.check_categoryAddedToProductAlert(FilePath_TestResult, TestCaseName, DataSet+1, testFail, checkedCatNameList);
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0011Data(){
