 ...
 *     	6. Input product keyword in product text box.
 *     	7. Click on "Find Categories" button.
 ...
 * Product keyword not entered, email address entered.
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0011 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0011_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0011Data")
	public void PA_LiteSignup_0011Test(String dataTestCaseName, 
		...
		try{		
			...
			// To verify Select Product Alert Categories page is displayed with no suggested categories.
			...
			// To verify A list of maximum 10 autocomplete keywords are displayed below the text box.
			PA_AddCategories_Page.check_pdtKeywordIsEntered(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataProductKeyword);

			// 7. Click on "Find Matching Categories" button.
			PA_AddCategories_Page.btn_clickFindMatchingCategories();
			
			// To verify suggested categories are displayed.
			...
			// To verify that upgrade upsell section is available and up to 10 PA categories selected in Step 8 are displayed.
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0011Data(){
