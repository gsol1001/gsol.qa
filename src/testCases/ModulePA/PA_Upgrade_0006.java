 ...
 * @TestCaseID 1050/ 6G
 * @TestArea PA Upgrade
 * @TestScenarioDesc PA upgrade from PA Lite Subscription Confirmation page
 * 
 * @TestStep
 * 
 ...
 *     	4. Enter a product keyword in product keyword textbox (e.g: MP3) and click on "Find Categories" button.
 *     	5. Check on any category checkboxes.
 *     	6. Click on "Subscribe Now" button.
 *     	7. Click on the "Upgrade Free" button.
 *     	8.  Fill up all the mandatory fields.
 *     	9. Check any eMag title checkbox (e.g: Electronics).
 *     	10. Make sure the Notification checkboxes are checked.
 *     	11. Click on the "Register Now" button.
 *     	12. Search for a keyword or choose an industry and check on any category checkboxes which are different from the categories in pre-req.
 *     	13. Click on "Subscribe Now" button.
...
/**
 * This test case contain method to test PA upgrade from PA Lite Subscription Confirmation page.
 * @author Teng Shyh Wei
 *
 */
public class PA_Upgrade_0006 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_Upgrade_0006_TestResult;
	...
	@Test(dataProvider="PA_Upgrade_0006Data")
	public void PA_Upgrade_0006Test(String dataTestCaseName, 
		...
		try{		
			...
			// 3. Enter a brand new email address in the email textbox and click on "Sign me up" button.
			...
			// 4. Enter a product keyword in product keyword textbox (e.g: MP3) and click on "Find Matching Categories" button.
			...
			PA_AddCategories_Action.ExecuteCatChkbxSelected_GreyedOut_AppearInSelColumn(
					FilePath_TestResult, TestCaseName, DataSet+1, testFail, checkedPACatNameList);
			
			// 6. Click on 'Go to Confirmation' button.
			PA_AddCategories_Page.btn_clickGoToConfirmation();
			
			// To verify PA Lite confirmation page is displayed. 
			// To verify that upgrade upsell section is available and up to 10 PA categories selected in Step 5 are displayed.
    	...
    	*/	
			...
			// To verify Select Product Alert Categories page is displayed. There is no suggested categories.			
			PA_AddCategories_Page.check_selPACatPageDisplayed_SuggCatNotAvailable(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// 13. Click on "Go to Confirmation" button.
			PA_AddCategories_Page.btn_clickGoToConfirmation();
			...
			// To verify that the PA categories selected in Step 12 are displayed.
			...
			// To verify that the PA categories selected in pre-req as well as Step 12 are displayed.
	 ...
	 */
	@DataProvider
	public Object[][] PA_Upgrade_0006Data(){
