...
/**
 * This test case contain method to test PA edit categories from PA Enhanced Entrance (L3 entry point).
 * @author Teng Shyh Wei
 *
 */
public class PA_EditCategories_0004 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0004_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0004Data")
	public void PA_EditCategories_0004Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		//	ProductInquiry_Action.ExecuteL3EntryPoint(dataCategoryKeyword);		// L3 entry point
			...
			// Go to L3 entry point, Click on the PA Enhanced Entrance 'Update me on new products' link.
			ProductInquiry_Action.ExecutePAEnhancedEntranceL3_ClickUpdateMeOnNewProductsLink(dataCategoryKeyword);
			
			// Go to L3 entry poiny
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0004Data(){
