 ...
 * @TestScenarioDesc PA Edit Categories from Product Vertical Homepages
 * @TestStep
 * 
 ...
 * 		password: asdf9876
 * 		
 * 		1. Go to any of the Product Vertical Homapages.
 * 		2. Click on the "please select categories" hyperlink.
...
import pageObjects.ProductVerticalHome_Page;
import pageObjects.TopNav_MenuBar;
import testCases.SuiteBase;
import testCases.ModulePA.SuiteBasePA;

/**
 * This test case contain method to test PA edit categories from Product Vertical Homepages
 * @author Teng Shyh Wei
 *
 */
public class PA_EditCategories_0014 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_EditCategories_0014_TestResult;
	...
	@Test(dataProvider="PA_EditCategories_0014Data")
	public void PA_EditCategories_0014Test(String dataTestCaseName,
			String dataUsername,
			String dataPassword,
		...
		try{		
			...
			// 1. Go to any of the Product Vertical Homepages.
			TopNav_MenuBar.subMenu_selectHardware();
			
			// To verify Product Vertical Homepage is displayed.
			// Verify that there is a "please select categories" hyperlink in Personalized Gallery section.
			TopNav_MenuBar.check_hardwarePageDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 2. Click on the "please select categories" hyperlink.
			ProductVerticalHome_Page.lnk_clickPleaseSelectCategories().click();
			
			// To verify Product Alert Add Categories page is displayed. There are suggested categories based on the vertical title keyword.
			PA_AddCategories_Action.ExecutePAAddCatPage_SuggCatByVerticalTitleKeywordExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] PA_EditCategories_0014Data(){
