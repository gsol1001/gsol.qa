...
/**
 * This test case contain method to test PA Lite signup from PA cross promotion (centrewell) (Article entry point).
 * @author Teng Shyh Wei
 *
 */
public class PA_LiteSignup_0020 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_LiteSignup_0020_TestResult;
	...
	@Test(dataProvider="PA_LiteSignup_0020Data")
	public void PA_LiteSignup_0020Test(String dataTestCaseName, 
		...
		try{		
			...
			NewsListing_Page.icon_PACatfishBanner_ClickOnCloseBtn();
			...
			NewsInquiry_Action.ExecutePACrossPromotion_EnterEmailAddr_ClickSubscribeBtn(dataEmailAddress);
	 ...
	 */
	@DataProvider
	public Object[][] PA_LiteSignup_0020Data(){
