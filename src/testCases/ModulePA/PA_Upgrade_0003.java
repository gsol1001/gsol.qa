 ...
 * @TestCaseID 1047/ 6D
 * @TestArea PA Upgrade
 * @TestScenarioDesc PA upgrade from PA Edit Categories
 * 
 * @TestStep
 * 
 ...
 *     	3. Click on "Register" link or "Register Now" button in upgrade upsell section.
...
/**
 * This test case contain method to test PA upgrade from Edit Categories.
 * @author Teng Shyh Wei
 *
 */
public class PA_Upgrade_0003 extends SuiteBasePA{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = PA_Upgrade_0003_TestResult;
	...
	@Test(dataProvider="PA_Upgrade_0003Data")
	public void PA_Upgrade_0003Test(String dataTestCaseName, 
		...
		//	PA_AddCategories_Action.ExecuteBrowserCategories_ChooseACategory();
			...
			// To verify PA Lite edit categories page is displayed. Verify that upgrade upsell section is available.
			...
			// 3. Click on "Register Now" button in upgrade upsell section.
			PALite_EditCategories_Page.btn_clickUpgradeUpsellRegisterNow().click();
    	...
    	*/	
			...
			// To verify the eMag title selected in Step 4 are displayed in "Magazine(s) Subscribed" section.
	 ...
	 */
	@DataProvider
	public Object[][] PA_Upgrade_0003Data(){
