 ...
 *     	2. Select "Other Suppliers" in "I am Looking for:" field. 
 ...
 *
 */
public class SuppAdvSearch_0010 extends SuiteBaseSearch{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SuppAdvSearch_0010_TestResult;
	...
	@Test(dataProvider="SuppAdvSearch_0010Data")
	public void SuppAdvSearch_0010Test(String dataTestCaseName, 
		...
		try{		
			...
			AdvancedSearch_Page.check_IamLookingForUnvSuppIsSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// To verify the results displayed contains only the matching unverified suppliers from the selected country in Step 6.
			...
			AdvancedSearch_Page.check_resultsDisplayedUnvSuppContainsOnlySelectedCountry(
	 ...
	 */
	@DataProvider
	public Object[][] SuppAdvSearch_0010Data(){
