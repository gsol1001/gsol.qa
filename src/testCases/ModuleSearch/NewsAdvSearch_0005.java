 ...
 *
 */
public class NewsAdvSearch_0005 extends SuiteBaseSearch{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = NewsAdvSearch_0005_TestResult;
	...
	@Test(dataProvider="NewsAdvSearch_0005Data")
	public void NewsAdvSearch_0005Test(String dataTestCaseName, 
		...
		//	Add_Log.info("Print keywords entered ::" + dataSearchMethod);
			...
			AdvancedSearch_Action.ExecuteAdvSearch_FillInAllFields(
					dataLookingFor, dataSearchKeyword, dataSearchMethod, dataCategory, dataCountry);
			...
			// To verify the results displayed contains only the matching News from the selected country in Step 6.			
	 ...
	 */
	@DataProvider
	public Object[][] NewsAdvSearch_0005Data(){
