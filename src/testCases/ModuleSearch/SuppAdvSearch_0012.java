 ...
 *
 */
public class SuppAdvSearch_0012 extends SuiteBaseSearch{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SuppAdvSearch_0012_TestResult;
	...
	@Test(dataProvider="SuppAdvSearch_0012Data")
	public void SuppAdvSearch_0012Test(String dataTestCaseName, 
		...
		try{		
			...
			// 2. Select 'All Suppliers types' in 'I am Looking for:' field.
			...
			// To verify 'All Suppliers types' is selected in 'I am Looking for:' field.
			...
			// To verify the results displayed contains all of the verified suppliers that match at least one of the keywords entered in Step 3.
			...
			AdvancedSearch_Page.check_allSuppResultsContainsAtLeastOneKeywords(
	 ...
	 */
	@DataProvider
	public Object[][] SuppAdvSearch_0012Data(){
