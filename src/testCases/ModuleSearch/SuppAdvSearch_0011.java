...
/**
 * This test case contain method to test Supplier advanced search.
 * @author Teng Shyh Wei
 *
 */
public class SuppAdvSearch_0011 extends SuiteBaseSearch{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SuppAdvSearch_0011_TestResult;
	...
	@Test(dataProvider="SuppAdvSearch_0011Data")
	public void SuppAdvSearch_0011Test(String dataTestCaseName, 
		...
		try{		
			...
			// To verify the results displayed contains all of the verified and unverified suppliers that match the keyword entered in Step 3.
			...
			AdvancedSearch_Page.check_allSuppResultsContainsAllKeywords(
					FilePath_TestResult, TestCaseName, DataSet+1, testFail, data1stKeyword);
	 ...
	 */
	@DataProvider
	public Object[][] SuppAdvSearch_0011Data(){
