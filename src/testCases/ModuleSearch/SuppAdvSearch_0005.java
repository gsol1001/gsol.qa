 ...
 *
 */
public class SuppAdvSearch_0005 extends SuiteBaseSearch{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SuppAdvSearch_0005_TestResult;
	...
	@Test(dataProvider="SuppAdvSearch_0005Data")
	public void SuppAdvSearch_0005Test(String dataTestCaseName, 
		...
		try{		
			...
			// To verify the results displayed contains only the matching verified suppliers from the selected country in Step 6.
			...
			AdvancedSearch_Page.check_resultsDisplayedVerSuppContainsOnlySelectedCountry(
	 ...
	 */
	@DataProvider
	public Object[][] SuppAdvSearch_0005Data(){
