/**
 * This class contains a method for Supplier Search
 ...
 * @TestCaseID 1146 / 18B
 * @TestArea Search
 * @TestScenarioDesc Supplier search
 * @TestStep
 * 
 *     	1. From any of the page, select 'Suppliers' from the dropdown list and click on the 'Search' button without entering any keyword.
 *     	2. Click on "OK" button.
 *     	3. Enter a keyword in keyword search textbox (e.g: China).  
 *     	4. Click on the "Search" button or press "Enter".
 *     	5. Check that in the listing, the keyword is bolded.
 *     	6. Enter a keyword that cannot be found in (e.g: chinaz) and click on the "Search" button.
 *     	7. Click on 'Did you mean: china' link.
 * 
...
/**
 * This test case contain method to test Supplier Search.
 * @author Teng Shyh Wei
 *
 */
public class SupplierSearch_0001 extends SuiteBaseUserAcc{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierSearch_0001_TestResult;
	...
	@Test(dataProvider="SupplierSearch_0002Data")
	public void SupplierSearch_0002Test(String dataTestCaseName, 
	 ...
	 */
	@DataProvider
	public Object[][] SupplierSearch_0002Data(){
