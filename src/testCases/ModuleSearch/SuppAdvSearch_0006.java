 ...
 * @version 1.01 Date: 2015/10/23
 * 
 * @TestCaseID 1150 / 18F
 * @TestArea Search
 * @TestScenarioDesc Supplier advanced search
 * @TestStep
 * 
 ...
 *
 */
public class SuppAdvSearch_0006 extends SuiteBaseSearch{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SuppAdvSearch_0006_TestResult;
	...
	@Test(dataProvider="SuppAdvSearch_0006Data")
	public void SuppAdvSearch_0006Test(String dataTestCaseName, 
		...
		try{		
			...
			// To verify the results displayed contains all of the unverified suppliers that match the keyword entered in Step 3.
			...
			AdvancedSearch_Page.check_unvSuppResultsContainsAllKeywords(
	 ...
	 */
	@DataProvider
	public Object[][] SuppAdvSearch_0006Data(){
