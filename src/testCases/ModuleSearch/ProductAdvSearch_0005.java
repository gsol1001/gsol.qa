/**
 * This class contains a method for Product Advance Search
 ...
 * @TestCaseID 1152 / 18M
 * @TestArea Search
 * @TestScenarioDesc Product advance search
 * @TestStep
 * 
 *     	1. From any of the page, select 'Advanced Search' from 'Search Options' drop down list.
 *     	2. Select "Products" in "I am Looking for:" field. 
 *     	3. Enter a keyword in keyword search textbox (e.g: Car MP3 Player). 
 *     	4. Select "Match all of my words" in "Search Method" field.
 *     	5. Select "All categories" in "Just in the category:" field.
 *     	6. Select any country other than "All Countries" in "Select countries:" field. (e.g: Taiwan)
...
/**
 * This test case contain method to test Product advance search.
 * @author Teng Shyh Wei
 *
 */
public class ProductAdvSearch_0005 extends SuiteBaseSearch{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = ProductAdvSearch_0005_TestResult;
	...
	@Test(dataProvider="ProductAdvSearch_0005Data")
	public void ProductAdvSearch_0005Test(String dataTestCaseName, 
		...
		try{		
			...
			// 2. Select 'Product' in 'I am Looking for:' field.
			...
			AdvancedSearch_Page.check_inputCountryIsSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataCountry);
			
			// 7. Click on "Search" button.
			AdvancedSearch_Page.btn_clickSearch().click();

			// To verify Keyword Search result page is displayed. 
			// To verify the results displayed contains only the matching PPs from the selected country in Step 6.
	 ...
	 */
	@DataProvider
	public Object[][] ProductAdvSearch_0005Data(){
