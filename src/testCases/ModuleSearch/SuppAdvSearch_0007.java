 ...
 *
 */
public class SuppAdvSearch_0007 extends SuiteBaseSearch{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SuppAdvSearch_0007_TestResult;
	...
	@Test(dataProvider="SuppAdvSearch_0007Data")
	public void SuppAdvSearch_0007Test(String dataTestCaseName, 
		...
		try{		
			...
			// To verify the results displayed contains all of the unverified suppliers that match at least one of the keywords entered in Step 3.
			...
			AdvancedSearch_Page.check_unvSuppResultsContainAtLeastOneKeywords(
	 ...
	 */
	@DataProvider
	public Object[][] SuppAdvSearch_0007Data(){
