 ...
 *     	2. Select "All Supplier types" in "I am Looking for:" field. 
 ...
 *
 */
public class SuppAdvSearch_0015 extends SuiteBaseSearch{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath = TestCaseListExcel_SuiteSearch_003_TestData;
		FilePath_TestResult = SuppAdvSearch_0015_TestResult;
	...
	@Test(dataProvider="SuppAdvSearch_0015Data")
	public void SuppAdvSearch_0015Test(String dataTestCaseName, 
		...
		try{		
			...
			AdvancedSearch_Page.check_IamLookingForAllSuppTypesIsSelected(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			...
			// To verify the results displayed contains only the matching All supplier types from the selected country in Step 6.
			...
			AdvancedSearch_Action.check_resultsDisplayedAllSuppContainsOnlySelectedCountry(
	 ...
	 */
	@DataProvider
	public Object[][] SuppAdvSearch_0015Data(){
