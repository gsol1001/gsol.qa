 ...
 *
 */
public class Refactor_0004 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Refactor_0004_TestResult;
	 ...
	 */
	@Test(dataProvider="Refactor_0004Data")
	public void Refactor_0004Test(String dataTestCaseName,
			String dataUsername,
		...
		try{
			...
			// Req 1.2.6.b.i
			// i. For DOI message, it'll not displayed when user has double opt-in.
			
			// Req 1.2.6.b.iii
			// iii.	For non SYP user, the user¡¯s menu includes User Profile, My Product Alert, Register as Supplier, Logout. 
			
			// 1. Login as non SYP user and DOI-ed user.
			// Email: autoqa.palite1002@gmail.com
			// Password: asdf9876
			...
			// To verify User Profile, My Product Alert, Register as Supplier and Logout button are displayed.
	 ...
	 */
	@DataProvider
	public Object[][] Refactor_0004Data(){
