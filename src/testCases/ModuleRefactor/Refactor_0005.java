 ...
 *
 */
public class Refactor_0005 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Refactor_0005_TestResult;
	 ...
	 */
	@Test(dataProvider="Refactor_0005Data")
	public void Refactor_0005Test(String dataTestCaseName,
			String dataUsername,
		...
		try{
			...
			// Req 1.2.6.b.i
			// i. For DOI message, it¡¯ll only display when user has not double opt-in yet.
			
			// Req 1.2.6.b.iii
			// iii.	For non SYP user, the user¡¯s menu includes User Profile, My Product Alert, Register as Supplier, Logout. 
			
			// 1. Login as non SYP user and non DOI user.
	 ...
	 */
	@DataProvider
	public Object[][] Refactor_0005Data(){
