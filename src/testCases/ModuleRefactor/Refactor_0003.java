/**
 * This class contains a method for SYP user
 * Created: Mon 11 Apr 2016
 * @author Teng Shyh Wei
 * @version 1.01 Date: 2016/04/11
 * 
 * @TestCaseID 1.2
 * @TestArea Logged in for SYP user
 ...
 *
 */
public class Refactor_0003 extends SuiteBaseRFI{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = Refactor_0003_TestResult;
	 ...
	 */
	@Test(dataProvider="Refactor_0003Data")
	public void Refactor_0003Test(String dataTestCaseName,
			String dataUsername,
		...
		try{
			...
			// Req 1.2.6.b.ii
			// ii. For SYP user, Display user¡¯s menu includes My Product Alert, Private Supplier Catalog, User Profile, Logout. 
			...
			// To verify My Product Alert, Private Supplier Catalog, User Profile and Logout button are displayed.
	 ...
	 */
	@DataProvider
	public Object[][] Refactor_0003Data(){
