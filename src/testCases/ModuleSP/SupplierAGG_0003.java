/**
 * This class contains a method for Inquire now from Left Nav at Supplier AGG PP page (Post Login)
 ...
 * @TestScenarioDesc Inquire now from Left Nav at Supplier AGG PP page (Post Login)
 * @TestStep
 * 
 ...
 * 		5. Fill in the "Password" field with valid password (asdf9876) and click on "Send Your Inquiry Now" button.
 * 		
 * 		
...
/**
 * This test case contain method to test Inquire now from Left Nav at Supplier AGG PP page (Post Login)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0003 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0003_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0003Data")
	public void SupplierAGG_0003Test(String dataTestCaseName, 
		...
		/*	// Do a Supplier keyword search.
			...
			// Get the PP name
			WebElement ppElement = driver.findElement(By.xpath("(//*[@id='unverProList']/li/a)[position()=1]"));
			String getPPName = ppElement.getText();
			Add_Log.info("Print PP SPD ::" + getPPName);
			
		    // Click on first PP SPD in Production promotion section
			UnvSupplier_Homepage.lnk_clickPPSPD().click();
		*/	
			
			// As a non logged-in user, go to Unverified PP page entry point.
		//	ProductInquiry_Action.ExecuteNonLoggedIn_UnverifiedPPEntryPoint(dataSearchKeyword);		// Unverified PP page entry point
        	...
        	RFIConfirmation_Action.check_onlyRFIConfirmationCopy_RFIUpsell_MiniMarketingBoxSectionIsExists(
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0003Data(){
