/**
 * This class contains a method for Inquire now from Product Highlights section at Supplier homepage
 * Created: Tue 19 Sep 2017
 * @author Teng Shyh Wei
 * @version 0.1 Date: 2017/09/19
 * 
 * @TestCaseID 41H
 * @TestArea Supplier Profile
 * @TestScenarioDesc Inquire now from Product Highlights section at Supplier homepage
 * @TestStep
 * 
 * 		1. As a non-logged in user, go to Supplier homepage.
 * 		2. At Product Highlights section, click on PP link inside the PP image.
...
import pageObjects.SupplierPP_Page;
import testCases.SuiteBase;

/**
 * This test case contain method to test Inquire now from Product Highlights section at Supplier homepage
 * @author Teng Shyh Wei
 *
 */
public class SupplierProfile_0008 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath = TestCaseListExcel_SuiteSP_001_TestData;
		FilePath_TestResult = SupplierProfile_0008_TestResult;
	...
	@Test(dataProvider= "SupplierProfile_0008Data")
	public void SupplierProfile_0008Test(String dataTestCaseName, 
		...
		try{
			...
			// 1. As a non-logged in user, go to Supplier homepage.
		//	SupplierInquiry_Action.ExecuteNonLoggedIn_GoToSupplierHomepage(dataSearchKeyword);
			...
			// 2. At Product Highlights section, click on PP link inside the PP image.
			SupplierHome_Page.lnk_clickPPLinkInRolloverImgPdtHighlights();
			
			// To verify Supplier PP page is displayed.
		//	SupplierPP_Page.check_verifiedSupplierPPPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getSuppName, getPPName);
			...
			// 3. Click on "Inquire Now" button at PP info section.
			SupplierPP_Page.btn_clickInquireNow().click();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierProfile_0008Data(){
