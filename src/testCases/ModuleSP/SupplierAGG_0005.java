/**
 * This class contains a method for Inquire now from Left Nav at Supplier AGG Trade Shows page (Logged-in user)
 ...
 * @TestScenarioDesc Inquire now from Left Nav at Supplier AGG Trade Shows page (Logged-in user)
 * @TestStep
 * 
 * 		1. Go to Supplier AGG Trade Shows page.
 * 		2. Click on "Login" button at the Global Nav.
 * 		3. Fill in the Username and Password and click on "Login Now" button.
 * 		4. Click on the "Inquire Now" button on the Left Nav.
...
/**
 * This test case contain method to test Inquire now from Left Nav at Supplier AGG Trade Shows page (Logged-in user)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0005 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0005_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0005Data")
	public void SupplierAGG_0005Test(String dataTestCaseName, 
		...
		//	SupplierInquiry_Action.ExecuteNonLoggedIn_GoToAGGSupplierHomepage(dataSearchKeyword);
			...
			// Click on "Trade Shows" sub menu
			UnvSupplier_Homepage.menuBar_clickTradeShows().click();
			
			// To verify Supplier AGG Trade Shows page is displayed.
			UnvSupplier_Homepage.check_AGGSuppTradeShowsPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getSuppName);
    		...
    		// To verify the original entry point page is displayed.
			UnvSupplier_Homepage.check_AGGSuppTradeShowsPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getSuppName);
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0005Data(){
