/**
 * This class contains a method for Inquire now from Related Verified Production List section at Supplier AGG homepage (single PP)
 ...
 * @TestScenarioDesc Inquire now from Related Verified Production List section at Supplier AGG homepage (single PP)
 * @TestStep
 * 
 * 		1. As a logged in user, go to Supplier AGG homepage.
 * 		2. Mouseover to any PP image in Related Verified Productions List section, click on "Inquire Now" button inside the Rollover Larger image.
 * 		3. Fill in all the relevant fields and click on "Contact Supplier Now" button
 * 
...
/**
 * This test case contain method to test Inquire now from Related Verified Production List section at Supplier AGG homepage (single PP)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0025 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0025_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0025Data")
	public void SupplierAGG_0025Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,			
		...
		try{
			...
			// 2. Mouseover to any PP image in Related Verified Production List section,    		
			// click on "Inquire Now" button inside the Rollover Larger image.
			UnvSupplier_Homepage.btn_clickInquireNowInsidePPImgAtRelatedVerPdtList();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0025Data(){
