/**
 * This class contains a method for Inquire Now from Related verified production list section at Supplier AGG Homepage (New User)
 * Created: Tue 10 Oct 2017
 * @author Teng Shyh Wei
 * @version 0.1 Date: 2017/10/010
 * 
 * @TestCaseID 43AC
 * @TestArea Supplier Profile
 * @TestScenarioDesc Inquire Now from Related verified production list section at Supplier AGG Homepage (New User)
 * @TestStep
 * 
 * 		1. As a non-logged in user, go to Supplier AGG homepage.
 * 		2. At Related Verified Productions List section, click on PP link inside the PP image.
 * 		3. Click on "Inquire Now" button.
 * 		4. Fill in all the relevant fields.
 * 		5. Click on the "Continue to Next Step" button.
 * 		6. Fill in the "Create a Password" and "Re-enter Password" fields with valid password and click on "Send Your Inquiry Now" button.
 * 		
...
/**
 * This test case contain method to test Inquire Now from Related verified production list section at Supplier AGG Homepage (New User)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0030 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0030_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0030Data")
	public void SupplierAGG_0030Test(String dataTestCaseName, 
		...
		try{
			...
			// 2. At Related Verified Productions List section, click on PP link inside the PP image.
			UnvSupplier_Homepage.lnk_clickPPSPDInsidePPImgAtRelatedVerPdtList();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0030Data(){
