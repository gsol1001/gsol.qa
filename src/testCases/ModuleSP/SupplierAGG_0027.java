/**
 * This class contains a method for Inquire now from Related Verified Production List section at Supplier AGG homepage (select all PPs)
 ...
 * @TestScenarioDesc Inquire now from Related Verified Production List section at Supplier AGG homepage (Select all PPs)
 * @TestStep
 * 
 * 		1. As a logged in user, go to Supplier AGG homepage.
 * 		2. Click on "Select all" link and click on "Inquire Now" button.
 ...
 *
 */
public class SupplierAGG_0027 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0027_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0027Data")
	public void SupplierAGG_0027Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,			
		...
		try{
			...
			// 2. Click on "Select all" link and click on "Inquire Now" button.
			UnvSupplierHome_Action.ExecuteClickSelectAllLink_ClickInquireNowBtn();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0027Data(){
