/**
 * This class contains a method for Inquire now from Floating contact section at Supplier homepage (Post Login)
 * Created: Tue 02 Aug 2017
 * @author Teng Shyh Wei
 * @version 0.1 Date: 2017/08/02
 * 
 * @TestCaseID 41R
 * @TestArea Supplier Profile
 * @TestScenarioDesc Inquire now from Floating contact section at Supplier homepage (Post Login)
 * @TestStep
 * 
 * 		1. As a logged-in user, go to GSOL PP entry point, verify that RFI floating window is available
 * 		2. Click on the RFI floating window.
 * 		3. Fill in some text in the RFI floating window
 * 		4. Click on the "Continue" button.
 * 		5. Fill in all the relevant fields and click on "Continue To Next Step" button.
 * 		6. Fill in the 'Create a Password' and 'Re-enter Password' field with valid password and click on 'Send Your Inquiry Now' button.
 * 
...
/**
 * This test case contain method to test Inquire now from Floating contact section at Supplier homepage (Post Login)
 * @author Teng Shyh Wei
 *
 */
public class SupplierProfile_0018 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierProfile_0018_TestResult;
	...
	@Test(dataProvider= "SupplierProfile_0018Data")
	public void SupplierProfile_0018Test(String dataTestCaseName, 
		...
		try{
    		...
    		// 2. Click on the "Inquire Now" button at the Floating Contact section.
    		SupplierHome_Page.btn_clickInquireNowAtFloatingContactSection().click();
        	...
        	RFIConfirmation_Action.check_RFIConfirmationForSupplierInquiryExists(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getSuppName);
	 ...
	 */
	@DataProvider
	public Object[][] SupplierProfile_0018Data(){
