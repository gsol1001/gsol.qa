/**
 * This class contains a method for Inquire now from Floating Contact section at Supplier AGG Product List page (New user)
 * Created: Wed 11 Oct 2017
 * @author Teng Shyh Wei
 * @version 0.1 Date: 2017/10/11
 * 
 * @TestCaseID 4AG
 * @TestArea Supplier Profile
 * @TestScenarioDesc Inquire now from Floating Contact section at Supplier AGG Product List page (New user)
 * @TestStep
 * 
 * 		1. As a new user, go to Supplier AGG Product List page.
...
/**
 * This test case contain method to test Inquire now from Floating Contact section at Supplier AGG Product List page (New user)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0033 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0033_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0033Data")
	public void SupplierAGG_0033Test(String dataTestCaseName, 
		...
		try{
			...
			// Click on "Product List" sub menu
			UnvSupplier_Homepage.menuBar_clickProductList().click();
			
			// To verify Supplier AGG Product List page is displayed.
			...
			// 2. Click on the "Inquire Now" button on the Floating Contact section.
			UnvSupplierHome_Action.ExecuteClickInqNowBtnAtFloatingContactSection();			
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0033Data(){
