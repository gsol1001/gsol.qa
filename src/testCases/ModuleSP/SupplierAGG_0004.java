/**
 * This class contains a method for Inquire now from Left Nav at Supplier AGG Company Profile page (New user)
 ...
 * @TestScenarioDesc Inquire now from Left Nav at Supplier AGG Company Profile page (New user)
 * @TestStep
 * 
 * 		1. As a new user, go to Supplier AGG Company Profile page.
...
/**
 * This test case contain method to test Inquire now from Left Nav at Supplier AGG Company Profile page (New user)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0004 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0004_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0004Data")
	public void SupplierAGG_0004Test(String dataTestCaseName, 
		...
		try{
			...
			// Click on "Company Profile" sub menu
			UnvSupplier_Homepage.menuBar_clickCompInformation().click();
			
			// To verify Supplier AGG Company Profile page is displayed.
			UnvSupplier_Homepage.check_AGGSuppCompProfilePageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getSuppName);
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0004Data(){
