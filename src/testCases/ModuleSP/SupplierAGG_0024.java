/**
 * This class contains a method for Inquire now from RFI Static form at Supplier AGG Contact Us page (Login on form)
 ...
 * @TestScenarioDesc Inquire now from RFI Static form at Supplier AGG Contact Us page (Login on form)
 * @TestStep
 * 
 * 		1. As a non-logged in user, go to Supplier AGG Contact Us page.
...
/**
 * This test case contain method to test Inquire now from RFI Static form at Supplier AGG Contact Us page (Login on form)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0024 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0024_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0024Data")
	public void SupplierAGG_0024Test(String dataTestCaseName, 
		...
		try{
            ...
            // Verify that the text entered in Step 2 are remain unchanged in the Message field.
            InquiryForm_Action.check_RFIFormDisplayed_TextEnteredInRFIStaticFormRemainUnchanged(
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0024Data(){
