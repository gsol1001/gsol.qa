 ...
 * 		2. At Product Highlights section, click on any PP image.
 ...
 * 		7. Click on "Continue to Next Step" button.
 * 
 ...
 *
 */
public class SupplierProfile_0006 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierProfile_0006_TestResult;
	...
	@Test(dataProvider= "SupplierProfile_0006Data")
	public void SupplierProfile_0006Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		try{
			...
			WebElement ppElement = driver.findElement(By.xpath("//*[@id='hlProducts']/li[1]/a"));
			String getPPName = ppElement.getText();
			Add_Log.info("Print PP name ::" + getPPName);
			
			// 2. At Product Highlights section, click on any PP image.
			SupplierHome_Page.img_clickFirstPPImageAtPdtHighlightsSection();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierProfile_0006Data(){
