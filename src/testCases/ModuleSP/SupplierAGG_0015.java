/**
 * This class contains a method for Inquire now from Production Promotion section at Supplier AGG homepage (select all PPs)
 ...
 * @TestScenarioDesc Inquire now from Production Promotion section at Supplier AGG homepage (select all PPs)
 * @TestStep
 * 
 * 		1. As a logged in user, go to Supplier AGG homepage.
 * 		2. Click on "Select all" link at Production Promotion section.
...
/**
 * This test case contain method to test Inquire now from Production Promotion section at Supplier AGG homepage (select all PPs)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0015 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0015_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0015Data")
	public void SupplierAGG_0015Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,			
		...
		try{
			...
			// 2. Click on "Select all" link at Production Promotion section.
			UnvSupplier_Homepage.lnk_clickSelectAll().click();
			
			// To verify all the PPs checkboxes are checked.
			UnvSupplier_Homepage.check_allPPsChkbxChecked(FilePath, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0015Data(){
