/**
 * This class contains a method for Inquire Now from Production Promotion section at Supplier AGG Homepage (Post Login)
 ...
 * @TestScenarioDesc Inquire Now from Production Promotion section at Supplier AGG Homepage (Post Login)
 * @TestStep
 * 
 * 		1. As a non-logged in user, go to Supplier AGG homepage.
 * 		2. At Production Promotion section, click on PP link under the PP image.
...
/**
 * This test case contain method to test Inquire Now from Production Promotion section at Supplier AGG Homepage (Post Login)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0017 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0017_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0017Data")
	public void SupplierAGG_0017Test(String dataTestCaseName, 
		...
		try{
			...
			// 2. At Production Promotion section, click on PP link under the PP image.
			UnvSupplier_Homepage.lnk_clickPPSPDUnderPPImg().click();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0017Data(){
