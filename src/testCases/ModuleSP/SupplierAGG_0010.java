/**
 * This class contains a method for Product Alert from Left Nav at Supplier AGG Company Profile page (Logged-in user)
 ...
 * @TestScenarioDesc Product Alert from Left Nav at Supplier AGG Company Profile page (Logged-in user)
 * @TestStep
 * 
 * 		1. As a logged in user, go to Supplier AGG Company Profile page.
...
/**
 * This test case contain method to test Product Alert from Left Nav at Supplier AGG Company Profile (Logged-in user)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0010 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0010_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0010Data")
	public void SupplierAGG_0010Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,			
		...
		try{
			...
			// Click on "Company Information" sub menu
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0010Data(){
