/**
 * This class contains a method for Inquire now from Production Promotion section at Supplier AGG homepage (single PP)
 ...
 * @TestScenarioDesc Inquire now from Production Promotion section at Supplier AGG homepage (single PP)
 * @TestStep
 * 
 * 		1. As a logged in user, go to Supplier AGG homepage.
 * 		2. Mouseover to any PP image in Production Promotion section.
...
/**
 * This test case contain method to test Inquire now from Production Promotion section at Supplier AGG homepage (single PP)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0013 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0013_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0013Data")
	public void SupplierAGG_0013Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,			
		...
		try{
			...
			UnvSupplier_Homepage.check_mouseoverPPImg_RolloverLargeImgIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
			
			// 3. Click on "Inquire Now" button inside the Rollover Larger image.
			UnvSupplier_Homepage.btn_clickInquireNowInsidePPImg();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0013Data(){
