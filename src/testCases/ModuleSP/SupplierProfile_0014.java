 ...
 * 		2. Click on "Select all" link at Latest Products section.
 ...
 *
 */
public class SupplierProfile_0014 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierProfile_0014_TestResult;
	...
	@Test(dataProvider= "SupplierProfile_0014Data")
	public void SupplierProfile_0014Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,
		...
		//	SupplierInquiry_Action.ExecuteLoggedIn_GoToSupplierHomepage(dataUsername, dataPassword, dataSearchKeyword);
			...
			// To verify all the PPs checkbox are checked.
			SupplierHome_Page.check_allPPsChkbxChecked(FilePath_TestResult, TestCaseName, DataSet+1, testFail);
	 ...
	 */
	@DataProvider
	public Object[][] SupplierProfile_0014Data(){
