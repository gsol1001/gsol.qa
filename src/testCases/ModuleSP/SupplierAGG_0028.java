/**
 * This class contains a method for Inquire now from Related verified production list section at Supplier AGG Homepage (Login on form)
 * Created: Mon 09 Oct 2017
 * @author Teng Shyh Wei
 * @version 0.1 Date: 2017/10/09
 * 
 * @TestCaseID 43AB
 * @TestArea Supplier Profile
 * @TestScenarioDesc Inquire now from Related verified production list section at Supplier AGG Homepage (Login on form)
 * @TestStep
 * 
 * 		1. As a non-logged in user, go to Supplier AGG homepage.
 * 		2. At Related verified production list section, click on any PP image.
...
/**
 * This test case contain method to test Inquire now from Related verified production list section at Supplier AGG Homepage (Login on form)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0028 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0028_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0028Data")
	public void SupplierAGG_0028Test(String dataTestCaseName, 
		...
		try{
			...
			// 2. At Related verified production list section, click on any PP image.
			UnvSupplier_Homepage.img_clickFirstPPImgAtRelatedVerPdtList();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0028Data(){
