/**
 * This class contains a method for Inquire Now from Related verified production list section at Supplier AGG Homepage (Post Login)
 ...
 * @TestScenarioDesc Inquire Now from Related verified production list section at Supplier AGG Homepage (Post Login)
 * @TestStep
 * 
 * 		1. As a non-logged in user, go to Supplier AGG homepage.
 * 		2. At Related verified production list section, click on PP link under the PP image.
 * 		3. Click on "Inquire Now" button.
 * 		4. Fill in all the relevant fields 
 * 		5. Click on the "Continue to Next Step" button
 * 		6. Fill in the "Password" field with valid password and click on "Send Your Inquiry Now" button.
 * 		
...
/**
 * This test case contain method to test Inquire Now from Related verified production list section at Supplier AGG Homepage (Post Login)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0029 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath = TestCaseListExcel_SuiteSP_007_TestData;
		FilePath_TestResult = SupplierAGG_0029_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0029Data")
	public void SupplierAGG_0029Test(String dataTestCaseName, 
		...
		try{
			...
			// 2. At Related verfified production list section, click on PP link under the PP image.
			UnvSupplier_Homepage.lnk_clickPPSPDUnderPPImgAtRelatedVerPdtList().click();
			
			// To verify Verified Supplier PP page is displayed.
		//	SupplierPP_Page.check_verifiedSupplierPPPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getSuppName, getPPName);
			...
			// 4. Fill in all the relevant fields.
    		InquiryForm_Action.FillIn_Subject_Message_ContactDetails(dataSubject, dataMessage, dataTitle, dataFirstName, dataLastName,
    				dataBusinessEmail, dataCompName, dataCountryTerritory, dataTelephoneNumber, dataRadbtnCompWebsiteURL, dataTxtbxCompWebsiteURL);
			
    		// Close the login overlay
    		MiniLogin_Page.icon_clickCloseBtn();
			
			// To verify the relevant fields are filled up.
			...
			// To verify headlines 'Recommended Products For You' is available on the page.
			// To verify '8 PPs of the inquired L4 category are displayed in each tab' is available on the page.
			// To verify 'Inquire Now' button displayed below each category
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0029Data(){
