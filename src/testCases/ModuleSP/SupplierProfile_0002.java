/**
 * This class contains a method for Inquire now from Left Nav Supplier homepage (Login on form)
 * Created: Fri 17 Mar 2017
 * @author Teng Shyh Wei
 * @version 0.1 Date: 2017/03/17
 * 
 * @TestCaseID 41B
 * @TestArea Supplier Profile
 * @TestScenarioDesc Inquire now from Left Nav Supplier homepage (Login on form)
 * @TestStep
 * 
 ...
 * 		2. Click on the "Inquire Now" button at Left Nav section
...
/**
 * This test case contain method to test Inquire now from Left Nav Supplier homepage (Login on form)
 * @author Teng Shyh Wei
 *
 */
public class SupplierProfile_0002 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierProfile_0002_TestResult;
	...
	@Test(dataProvider= "SupplierProfile_0002Data")
	public void SupplierProfile_0002Test(String dataTestCaseName,
		...
		try{
    		...
    		// 2. Click on the "Inquire Now" button at the Left Nav section.
	 ...
	 */
	@DataProvider
	public Object[][] SupplierProfile_0002Data(){
