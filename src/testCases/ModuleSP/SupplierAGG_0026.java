/**
 * This class contains a method for Inquire now from Related Verified Production List section at Supplier AGG homepage (multiple PPs)
 ...
 * @TestScenarioDesc Inquire now from Related Verified Production List section at Supplier AGG homepage (multiple PPs)
 * @TestStep
 * 
 * 		1. As a logged in user, go to Supplier AGG homepage.
 * 		2. Check on multiple PPs checkboxes and click on "Inquire Now" button.
...
/**
 * This test case contain method to test Inquire now from Related Verified Production List section at Supplier AGG homepage (multiple PPs)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0026 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0026_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0026Data")
	public void SupplierAGG_0026Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,			
		...
		try{
			...
			// 2. Check on multiple PPs checkboxes and click on "Inquire Now" button.
		// 	UnvSupplierHome_Action.ExecuteSelectMultiplePPsChkbx_ClickInquireNowBtn();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0026Data(){
