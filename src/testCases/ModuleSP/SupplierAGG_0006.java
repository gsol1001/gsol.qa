/**
 * This class contains a method for Inquire now from Left Nav at Supplier AGG Contact Us page (Login on form)
 * Created: Thu 07 Sep 2017
 * @author Teng Shyh Wei
 * @version 0.1 Date: 2017/09/07
 * 
 * @TestCaseID 43F
 * @TestArea Supplier Profile
 * @TestScenarioDesc Inquire now from Left Nav at Supplier AGG Contact Us page (Login on form)
 * @TestStep
 * 
 * 		1. Go to Supplier AGG Contact Us page.
 * 		2. Click on the "Inquire Now" button at the Left Nav.
 * 		3. Enter some texts in "Subject" and "Message" fields.
 * 		4. Click on the "Login Now" button.
 * 		5. Fill in E-mail and Password and click on "Login Now" button.
...
/**
 * This test case contain method to test Inquire now from Left Nav at Supplier AGG Contact Us page (Login on form)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0006 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0006_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0006Data")
	public void SupplierAGG_0006Test(String dataTestCaseName, 
		...
		try{
			...
			// 1. Go to Supplier AGG Contact Us page.
		//	SupplierInquiry_Action.ExecuteNonLoggedIn_GoToAGGSupplierHomepage(dataSearchKeyword);
			...
			// Click on "Contact Us" sub menu
			UnvSupplier_Homepage.menuBar_clickContactUs().click();
			
			// To verify Supplier AGG Contact Us page is displayed.
			UnvSupplier_Homepage.check_AGGSuppContactUsPageIsDisplayed(FilePath_TestResult, TestCaseName, DataSet+1, testFail, getSuppName);
			
			// 2. Click on the "Inquire Now" button on the Left Nav.
			SupplierHome_Page.btn_clickInquireNowAtLeftNav().click();
			...
			InquiryForm_Page.check_subjectMessageFieldsEnteredWithText(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataSubject, dataMessage);
			...
			// To verify RFI Form is displayed. Verify that the text entered in "Subject" and "Message" are remain unchanged.
			InquiryForm_Page.check_textSubjectMessageRemainUnchanged(FilePath_TestResult, TestCaseName, DataSet+1, testFail, dataSubject, dataMessage);
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0006Data(){
