/**
 * This class contains a method for Inquire now from Production Promotion section at Supplier AGG homepage (multiple PPs)
 * Created: Thu 05 Oct 2017
 * @author Teng Shyh Wei
 * @version 0.1 Date: 2017/10/05
 * 
 * @TestCaseID 43N
 * @TestArea Supplier Profile
 * @TestScenarioDesc Inquire now from Production Promotion section at Supplier AGG homepage (multiple PPs)
 * @TestStep
 * 
 * 		1. As a logged in user, go to Supplier AGG homepage.
 * 		2. Select multiple PPs checkboxes at Production Promotion section.
 * 		3. Click on "Inquire Now" button inside the Rollover Larger image.
 * 		4. Fill in all the relevant fields and click on "Contact Supplier Now" button.
 * 
...
/**
 * This test case contain method to test Inquire now from Production Promotion section at Supplier AGG homepage (multiple PPs)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0014 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0014_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0014Data")
	public void SupplierAGG_0014Test(String dataTestCaseName, 
			String dataUsername,
			String dataPassword,			
		...
		try{
			...
			UnvSupplier_Homepage.chkbx_select1stPPChkbx();
			Thread.sleep(2000);
			UnvSupplier_Homepage.chkbx_select2ndPPChkbx();
			
			Thread.sleep(3000);
			
			// 3. Click on "Inquire Now" button.
			UnvSupplier_Homepage.btn_ProdPromoSection_ClickInquireNow().click();
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0014Data(){
