/**
 * This class contains a method for Inquire now from RFI Static form at Supplier AGG Trade Shows page (Logged-in user)
 ...
 * @TestScenarioDesc Inquire now from RFI Static form at Supplier AGG Trade Shows page (Logged-in user)
 * @TestStep
 * 
 * 		1. As a logged in user, go to Supplier AGG Trade Shows page.
...
/**
 * This test case contain method to test Inquire now from RFI Static form at Supplier AGG Trade Shows page (Logged-in user)
 * @author Teng Shyh Wei
 *
 */
public class SupplierAGG_0023 extends SuiteBaseSP{
	...
	public void checkCaseToRun() throws IOException{
		...
		FilePath_TestResult = SupplierAGG_0023_TestResult;
	...
	@Test(dataProvider= "SupplierAGG_0023Data")
	public void SupplierAGG_0023Test(String dataTestCaseName, 			
			String dataUsername,
			String dataPassword,			
	 ...
	 */
	@DataProvider
	public Object[][] SupplierAGG_0023Data(){
